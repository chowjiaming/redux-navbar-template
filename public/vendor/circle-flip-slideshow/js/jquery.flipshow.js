...
(function($, window, undefined) {
  ...
  $.fn.imagesLoaded = function(callback) {
    ...
    if (!$images.length) {
      ...
      $images
        .bind("load.imagesLoaded error.imagesLoaded", imgLoadedHandler)
        .each(function(i, el) {
          var src = el.src;
  ...
  $.Flipshow.prototype = {
    _init: function(options) {
      ...
      if (this.support) {
        this.transEndEventName =
          transEndEventNames[Modernizr.prefixed("transition")] + ".cbpFWSlider";
    ...
    _addNav: function() {
      ...
      $("<nav></nav>")
        .append($navLeft, $navRight)
        .appendTo(this.$el);

      $navLeft
        .find("span")
        .on("click.flipshow touchstart.flipshow", function() {
    ...
    _layout: function($current, $next) {
      ...
      this.$flipEl = $('<div class="fc-flip"></div>')
    ...
    _flip: function($currentItem, $nextItem, dir, angle) {
      ...
      setTimeout(function() {
        ...
        self.$flipEl.on(self.transEndEventName, function(event) {
          if (
            event.target.className === "fc-overlay-light" ||
            event.target.className === "fc-overlay-dark"
          )
            return;
  ...
  $.fn.flipshow = function(options) {
    if (typeof options === "string") {
      ...
      this.each(function() {
        ...
        if (!instance) {
          logError(
            "cannot call methods on flipshow prior to initialization; " +
