...
if (
          ...
          d = [
            !/opera|webtv/i.test(o) && /msie\s(\d)/.test(o)
              ...
              ? n +
                " " +
                a +
                (/version\/(\d+)/.test(o) ? " " + a + RegExp.jQuery1 : "")
              : i("mozilla/")
              ? s
              : "",
            i("j2me")
        ...
        (c = d.join(" ")),
          ...
          !window.ActiveXObject && "ActiveXObject" in window
            ? p("html")
                .removeClass("gecko")
                .addClass("ie ie11")
            : (p("body").hasClass("dark") && p("html").addClass("dark"),
              p("body").hasClass("boxed") && p("html").addClass("boxed"));
      }
    }),
      p.browserSelector();
  })(jQuery),
      ...
      setTimeout(function() {
        ...
        $(t).get(0) &&
          ($("a[href$='" + window.location.hash + "']").is("[data-hash-offset]")
            ...
            : $("html").is("[data-hash-offset]") &&
              (e = parseInt($("html").attr("data-hash-offset"))),
  ...
  jQuery(".image-hotspot")
    .append('<span class="ring"></span>')
    .append('<span class="circle"></span>'),
  (function(t) {
    t("body[data-plugin-page-transition]").get(0) &&
      t(window).on("beforeunload", function() {
        t("body").addClass("page-transition-active");
      });
  })(jQuery),
  (function(e) {
    e(".thumb-info-floating-caption").get(0) &&
      (e(".thumb-info-floating-caption")
        .on("mouseenter", function() {
          e(".thumb-info-floating-caption-title").get(0) ||
            (e(".body").append(
            ...
            e(this).data("type") &&
              e(".thumb-info-floating-caption-title")
                .append(
            ...
            e(this).hasClass("thumb-info-floating-caption-clean") &&
              e(".thumb-info-floating-caption-title").addClass(
                "bg-transparent"
              ));
        })
  ...
  (function(o) {
    o("[data-toggle-text-click]").on("click", function() {
      o(this).text(function(t, e) {
        return e === o(this).attr("data-toggle-text-click")
          ? o(this).attr("data-toggle-text-click-alt")
          : o(this).attr("data-toggle-text-click");
      });
    });
  })(jQuery),
  (function(t) {
    ...
    (a.DEFAULTS = {
      ...
      (n.fn.countTo = function(s) {
        return this.each(function() {
          ...
          (!e || "object" == typeof s) &&
            (e && e.stop(), t.data("countTo", (e = new a(this, o)))),
            e[i].call(e);
        });
      });
  }),
      ...
      if (!(this.length < 1)) {
        ...
        if ("function" == typeof l.getBoundingClientRect) {
          var u = l.getBoundingClientRect(),
            h = n
              ? 0 <= u.top - r.top && u.top < d + r.top
              : 0 <= u.top && u.top < d,
            f = n
              ? 0 < u.bottom - r.top && u.bottom <= d + r.top
              : 0 < u.bottom && u.bottom <= d,
            m = n
              ? 0 <= u.left - r.left && u.left < c + r.left
              : 0 <= u.left && u.left < c,
            v = n
              ? 0 < u.right - r.left && u.right < c + r.left
              : 0 < u.right && u.right <= c,
            g = t ? h || f : h && f,
            w = t ? m || v : m && v;
      ...
      d = function(t) {
        ...
        return (
          e.each(function() {
            ...
            null === o
              ? s.push(t)
              : Math.floor(Math.abs(i - e)) <= 1
              ? (s[s.length - 1] = o.add(t))
              : s.push(t),
              (i = e);
          }),
          s
    ...
    (u.version = "0.7.2"),
      ...
      (u._apply = function(t, e) {
        ...
        return (
          ...
          u._maintainScroll &&
            l(window).scrollTop((s / a) * l("html").outerHeight(!0)),
          this
        );
      }),
    ...
    (h.waitForImages = {
      ...
      (h.fn.waitForImages = function() {
        var n,
          ...
          u = /url\(\s*(['"]?)(.*?)\1\s*\)/g;
        if (
          (h.isPlainObject(arguments[0])
            ? ((e = arguments[0].waitForAll),
              (r = arguments[0].each),
              (a = arguments[0].finished))
            : (e =
                1 === arguments.length && "boolean" === h.type(arguments[0])
                  ? arguments[0]
                  : ((a = arguments[0]), (r = arguments[1]), arguments[2])),
          (a = a || h.noop),
          (r = r || h.noop),
          (e = !!e),
          !h.isFunction(a) || !h.isFunction(r))
        )
        ...
        return (
            ...
            e
              ? t
                  ...
                  .each(function() {
                    ...
                    s.is("img:has-src") &&
                      !s.is("[srcset]") &&
                      p.push({ src: s.attr("src"), element: s[0] }),
                      h.each(o, function(t, e) {
                        var o,
                          i = s.css(e);
                        if (!i) return !0;
                        for (; (o = u.exec(i)); )
                          p.push({ src: o[2], element: s[0] });
                      }),
          ...
          (n = p.length),
          (l = 0) === n && (a.call(d), c.resolveWith(d)),
          h.each(p, function(t, i) {
            var e = new Image(),
              s = "load." + f + " error." + f;
            h(e).one(s, function t(e) {
              ...
              if (
                (l++,
                r.apply(i.element, o),
                c.notifyWith(i.element, o),
                h(this).off(s, t),
                l == n)
              )
                return a.call(d[0]), c.resolveWith(d[0]), !1;
            }),
  ...
  (function(t, c) {
    fontSpy = function(t, e) {
      ...
      var s = {
        ...
        n = c.extend(s, e),
        a = c("<span>" + n.testString + n.glyphs + "</span>")
          .css("position", "absolute")
          .css("top", "-9999px")
          .css("left", "-9999px")
          .css("visibility", "hidden")
          .css("fontFamily", n.testFont)
          .css("fontSize", "250px");
      i.append(a);
      var r = a.outerWidth();
      ...
      var l = function() {
        ...
        r !== t
          ? (n.callback(),
            o.addClass(n.fontClass),
            n && n.success && n.success(),
            a.remove())
          : n.timeOut < 0
          ? (o.addClass("no-" + n.fontClass),
            n && n.failure && n.failure(),
            n.callback(new Error("FontSpy timeout")),
            a.remove())
          : (setTimeout(l, n.delay), (n.timeOut = n.timeOut - n.delay));
      };
      l();
    };
  })(0, jQuery),
    ...
    u.fn.pin = function(l) {
      ...
      var o = function() {
          for (var t = 0, e = c.length; t < e; t++) {
            var o = c[t];
            if (l.minWidth && p.width() <= l.minWidth)
              o.parent().is(".pin-wrapper") && o.unwrap(),
                o.css({ width: "", left: "", top: "", position: "" }),
                l.activeClass && o.removeClass(l.activeClass),
                (d = !0);
            else {
              d = !1;
              var i = l.containerSelector
                  ? o.closest(l.containerSelector)
                  : u(document.body),
                s = o.offset(),
                n = i.offset(),
                a = o.parent().offset();
              o.parent().is(".pin-wrapper") ||
                o.wrap("<div class='pin-wrapper'>");
            ...
            for (var t = [], e = 0, o = c.length; e < o; e++) {
              ...
              if (s) {
                ...
                var n = s.from - s.pad.bottom,
                  a = s.to - s.pad.top;
                n + i.outerHeight() > s.end
                  ? i.css("position", "")
                  : n < r && r < a
                  ? ("fixed" != i.css("position") &&
                      i
                        .css({ left: i.offset().left, top: s.pad.top })
                        .css("position", "fixed"),
                    l.activeClass && i.addClass(l.activeClass))
                  : a <= r
                  ? (i
                      .css({ left: "", top: a - s.parentTop + s.pad.top })
                      .css("position", "absolute"),
                    l.activeClass && i.addClass(l.activeClass))
  ...
  (function(o) {
    "use strict";
    var s,
      n = { action: function() {}, runOnLoad: !1, duration: 500 },
      a = !1,
      i = {
        init: function() {
  ...
  jQuery(document).ready(function(a) {
    ...
    function m(t, e) {
      t.parents(".word-rotator").hasClass("type")
        ? (v(t.find("i").eq(0), t, !1, e),
          t.addClass("is-visible").removeClass("is-hidden"))
        : t.parents(".word-rotator").hasClass("clip") &&
          t
            .parents(".word-rotator-words")
            .animate({ width: t.outerWidth() + 10 }, h, function() {
              setTimeout(function() {
                f(t);
              }, o);
            });
      ...
      return this.each(function() {
        ...
        t.css({
          ...
          t.on("mouseenter", function() {
            return (
              p.addClass(h.hoverInClass + " " + h.hoverClass),
              (currentX = currentY = 0),
          ...
          t.on("mousemove", function(t) {
            return (
              ...
              (o = p.innerWidth()),
              (i = p.innerHeight()),
              (s = Math.round(e.pageX - p.offset().left)),
              (n = Math.round(e.pageY - p.offset().top)),
              (a = h.invert
                ? (o / 2 - s) / h.sensitivity
                : -(o / 2 - s) / h.sensitivity),
              (r = h.invert
              ...
              (l = s - o / 2),
              (c = n - i / 2),
              (d = (180 * Math.atan2(c, l)) / Math.PI - 90) < 0 && (d += 360),
              p.css({
                perspective: h.perspective + "px",
                transformStyle: "preserve-3d",
          ...
          t.on("mouseleave", function() {
            return (
              p.addClass(h.hoverOutClass + " " + h.hoverClass),
              p.css({
                perspective: h.perspective + "px",
                transformStyle: "preserve-3d",
...
!(function(o) {
  var t = {
    ...
    build: function() {
      ...
      o(window).height() - o(".header-body").height() < t
        ? (o("#footer").removeClass("footer-reveal"),
          o(".main").css("margin-bottom", 0))
        : (o("#footer").addClass("footer-reveal"),
          o(".main").css("margin-bottom", t));
    },
    events: function() {
      var t = this,
        e = o(window);
