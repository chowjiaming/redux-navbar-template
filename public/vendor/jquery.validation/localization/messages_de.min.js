...
!(function(a) {
  ...
  return (
    a.extend(a.validator.messages, {
      ...
      step: a.validator.format("Geben Sie bitte ein Vielfaches von {0} ein."),
      maxWords: a.validator.format(
        "Geben Sie bitte {0} Wörter oder weniger ein."
      ),
      minWords: a.validator.format(
        "Geben Sie bitte mindestens {0} Wörter ein."
      ),
      ...
      extension:
        "Geben Sie bitte einen Wert mit einer gültigen Erweiterung ein.",
      ...
      postalcodeIT:
        "Geben Sie bitte eine gültige italienische Postleitzahl ein.",
      postalcodeNL:
      ...
      time:
        "Geben Sie bitte eine gültige Uhrzeit zwischen 00:00 und 23:59 ein.",
