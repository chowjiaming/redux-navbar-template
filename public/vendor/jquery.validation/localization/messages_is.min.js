...
!(function(a) {
  ...
  return (
    a.extend(a.validator.messages, {
      ...
      maxlength: a.validator.format("Sláðu inn mest {0} stafi."),
      minlength: a.validator.format("Sláðu inn minnst {0} stafi."),
      rangelength: a.validator.format(
        "Sláðu inn minnst {0} og mest {1} stafi."
      ),
      ...
      range: a.validator.format("Sláðu inn gildi milli {0} og {1}."),
