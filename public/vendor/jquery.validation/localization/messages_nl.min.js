...
!(function(a) {
  ...
  return (
    a.extend(a.validator.messages, {
      ...
      maxlength: a.validator.format("Vul hier maximaal {0} tekens in."),
      minlength: a.validator.format("Vul hier minimaal {0} tekens in."),
      ...
      step: a.validator.format("Vul hier een veelvoud van {0} in."),
