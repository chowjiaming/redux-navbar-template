...
!(function(e, t, n) {
  ...
  function a(e) {
    ...
    Modernizr._config.enableClasses &&
      ((t += " " + n + e.join(" " + n)),
      w ? (E.className.baseVal = t) : (E.className = t));
  }
  function i(e) {
    return e
  ...
  function c(e, n, r, o) {
    ...
    return (
      ...
      (i = n(d, e)),
      p.fake
        ? (p.parentNode.removeChild(p), (E.style.overflow = u), E.offsetHeight)
