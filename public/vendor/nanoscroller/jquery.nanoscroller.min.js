!(function(e) {
  ...
  "use strict";
  var p, d, i, c, a, u, e, g, v, f, l, r, h, S, m, T, y, b, w, x, $, H, C, O, A;
  (b = {
    paneClass: "nano-pane",
    ...
    (m = "touchmove"),
    (p =
      "Microsoft Internet Explorer" === n.navigator.appName &&
      /msie 7./i.test(n.navigator.appVersion) &&
      n.ActiveXObject),
    (d = null),
    ...
    (A = (function() {
      var t, e, i, s;
      for (
        t = i = 0, s = (e = ["t", "webkitT", "MozT", "msT", "OT"]).length;
        i < s;
        t = ++i
      )
        if ((e[t], e[t] + "ransform" in O))
          return e[t].substr(0, e[t].length - 1);
      return !1;
    })()),
    (C = (function(t) {
      return (
        !1 !== A && ("" === A ? t : A + t.charAt(0).toUpperCase() + t.substr(1))
      );
    })("transform")),
    (x = !1 !== C),
    (w = function() {
    ...
    ($ = function() {
      ...
      return (
        ...
        !!(t = /(?=.+Mac OS X)(?=.+Firefox)/.test(e)) &&
          ((i = /Firefox\/\d{2}\./.exec(e)) && (i = i[0].replace(/\D+/g, "")),
          t && 23 < +i)
      );
    }),
    (r = (function() {
      ...
      return (
        (t.prototype.preventScrolling = function(t, e) {
          if (this.isActive)
            if (t.type === i)
              ((e === c && 0 < t.originalEvent.detail) ||
                (e === T && t.originalEvent.detail < 0)) &&
                t.preventDefault();
            else if (t.type === l) {
              if (!t.originalEvent || !t.originalEvent.wheelDelta) return;
              ((e === c && t.originalEvent.wheelDelta < 0) ||
                (e === T && 0 < t.originalEvent.wheelDelta)) &&
                t.preventDefault();
            }
        }),
        ...
        (t.prototype.setOnScrollStyles = function() {
          var t, e;
          x
            ? ((t = {})[C] = "translate(0, " + this.sliderTop + "px)")
              ...
              function(t) {
                return (
                  (r.sliderY =
                    ...
                    r.$el.offset().top -
                    r.paneTop -
                    (r.offsetY || 0.5 * r.sliderHeight)),
                  r.scroll(),
                  r.contentScrollTop >= r.maxScrollTop &&
                  r.prevScrollTop !== r.maxScrollTop
                    ? r.$el.trigger("scrollend")
                    : 0 === r.contentScrollTop &&
                      0 !== r.prevScrollTop &&
                      r.$el.trigger("scrolltop"),
                  !1
                );
              }),
            up:
              ...
              function(t) {
                return (
                  (l.isBeingDragged = !1),
                  l.pane.removeClass("active"),
                  l.doc.unbind(v, l.events[a]).unbind(f, l.events.up),
                  l.body.unbind(g, l.events[u]),
                  !1
                );
              }),
            resize:
              ...
              function(t) {
                ...
                if (i.isBeingDragged)
                  return 1 !== (t.buttons || t.which)
                    ? (e = i.events).up.apply(e, arguments)
                    : void 0;
              })
          };
        }),
        (t.prototype.addEvents = function() {
          ...
          this.removeEvents(),
            ...
            this.iOSNativeScrolling ||
              (this.slider.bind(e, t[c]),
              this.pane.bind(e, t.panedown).bind(l + " " + i, t.wheel)),
            this.$content.bind(S + " " + l + " " + i + " " + m, t[S]);
        }),
        (t.prototype.removeEvents = function() {
          var t;
          (t = this.events),
            this.win.unbind(h, t[h]),
            this.iOSNativeScrolling ||
              (this.slider.unbind(), this.pane.unbind()),
            this.$content.unbind(S + " " + l + " " + i + " " + m, t[S]);
        }),
        (t.prototype.generate = function() {
          ...
          return (
            ...
            (o = e.sliderClass),
            e.contentClass,
            (i = this.$el.children("." + s)).length ||
              i.children("." + o).length ||
              this.$el.append(
                '<div class="' + s + '"><div class="' + o + '" /></div>'
              ),
            ...
            0 === d && $()
              ...
              : d && ((t = { right: -d }), this.$el.addClass("has-scrollbar")),
        ...
        (t.prototype.reset = function() {
          ...
          if (!this.iOSNativeScrolling)
            return (
              ...
              (e = t.scrollHeight + d),
              0 < (h = parseInt(this.$el.css("max-height"), 10)) &&
                (this.$el.height(""),
                this.$el.height(t.scrollHeight > h ? h : t.scrollHeight)),
              (l =
                (n = this.pane.outerHeight(!1)) +
                (r = parseInt(this.pane.css("top"), 10)) +
                parseInt(this.pane.css("bottom"), 10)),
              (a = Math.round((l / e) * n)) < this.options.sliderMinHeight
                ? (a = this.options.sliderMinHeight)
                : null != this.options.sliderMaxHeight &&
                  a > this.options.sliderMaxHeight &&
                  (a = this.options.sliderMaxHeight),
              ...
              (this.pane.outerHeight(!0) >= t.scrollHeight && o !== S)
              ...
              ("static" !== (i = this.$content.css("position")) &&
                "relative" !== i) ||
                ((c = parseInt(this.$content.css("right"), 10)) &&
                  this.$content.css({ right: "", marginRight: c })),
              this
            );
        ...
        (t.prototype.scrollTop = function(t) {
          if (this.isActive)
            return (
              this.$content.scrollTop(+t).trigger(l),
              this.stop().restore(),
              this
            );
        }),
    ...
    (s.fn.nanoScroller = function(i) {
      return this.each(function() {
        ...
        if (
          ((e = this.nanoscroller) ||
            ((t = s.extend({}, b, i)),
            (this.nanoscroller = e = new r(this, t))),
          i && "object" == typeof i)
        ) {
