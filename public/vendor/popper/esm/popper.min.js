...
function g(e) {
  ...
  for (
    var t = c(10) ? document.body : null, o = e.offsetParent || null;
...
function O(e) {
  var t = e.body,
    o = e.documentElement,
    n = c(10) && getComputedStyle(o);
  return { height: v("Height", t, o, n), width: v("Width", t, o, n) };
}
var L = function(e, t) {
    if (!(e instanceof t))
...
function N(e) {
  ...
  var i = {
    ...
    r = "HTML" === e.nodeName ? O(e.ownerDocument) : {},
...
function P(e, t) {
  ...
  n && r && ((s.top = o(s.top, 0)), (s.left = o(s.left, 0)));
  var g = D({
    top: p.top - s.top - m,
...
function H(e, t, o, n) {
  ...
  return (
    (r.left += c ? o : o.left || 0),
    (r.top += c ? o : o.top || 0),
    (r.right -= c ? o : o.right || 0),
    (r.bottom -= c ? o : o.bottom || 0),
    r
  );
}
function A(e) {
...
function j(e, t, o) {
  var n = void 0 === o ? e : e.slice(0, V(e, "name", o));
  return (
...
var pe = e && /Firefox/i.test(navigator.userAgent);
function se(e, t) {
  var o = t.x,
    n = t.y,
    i = e.offsets.popper,
    r = Y(e.instance.modifiers, function(e) {
  ...
  var p,
    s,
    d = void 0 === r ? t.gpuAcceleration : r,
    a = g(e.instance.popper),
    l = N(a),
    f = { position: i.position },
    m = re(e, 2 > window.devicePixelRatio || !pe),
  ...
  if (
    ...
    var b = "bottom" == h ? -1 : 1,
      w = "right" == c ? -1 : 1;
    (f[h] = s * b), (f[c] = p * w), (f.willChange = h + ", " + c);
  }
  var y = { "x-placement": e.placement };
  return (
    (e.attributes = C({}, y, e.attributes)),
    (e.styles = C({}, f, e.styles)),
...
var Le = {
    ...
    keepTogether: { order: 400, enabled: !0, fn: ue },
