...
function v(e) {
  ...
  return { height: x("Height", t, o, n), width: x("Width", t, o, n) };
}
var O =
  Object.assign ||
  function(e) {
...
function T(e, t, o = !1) {
  ...
  return (
    (i && !o ? t.contains(f) : t === f && "BODY" !== f.nodeName) &&
      (u = y(u, t)),
    u
  );
}
...
function q(e, t, o, n) {
  ...
  r.addEventListener(t, o, { passive: !0 }),
    i || q(a(r.parentNode), t, o, n),
    n.push(r);
}
function z(e, t, o, n) {
  (o.updateBound = n),
    K(e).addEventListener("resize", o.updateBound, { passive: !0 });
  const i = a(e);
  return (
    q(i, "scroll", o.updateBound, o.scrollParents),
    (o.scrollElement = i),
    (o.eventsEnabled = !0),
    o
  );
...
function X() {
  this.state.eventsEnabled &&
    ...
    (this.state = _(this.reference, this.state)));
}
function J(e) {
...
function $(e) {
  return (
    ...
    Z(e.instance.popper, e.attributes),
    e.arrowElement &&
...
function ee(e, t, o, n, i) {
  ...
  return (
    ...
    Q(t, { position: o.positionFixed ? "fixed" : "absolute" }),
    o
  );
}
function te(e, t) {
  const { popper: o, reference: n } = e.offsets,
    { round: i, floor: r } = Math,
    p = e => e,
    d = i(n.width),
    s = i(o.width),
...
function ne(e, t) {
  ...
  if (
    ((g =
      "bottom" == l
        ? "HTML" === d.nodeName
          ? -d.clientHeight + a.bottom
          : -s.height + a.bottom
        : a.top),
    (u =
      "right" == m
        ? "HTML" === d.nodeName
          ? -d.clientWidth + a.right
          : -s.width + a.right
        : a.left),
    p && h)
  )
    (f[h] = `translate3d(${u}px, ${g}px, 0)`),
      (f[l] = 0),
      (f[m] = 0),
...
function re(e, t) {
  ...
  const n = e.placement.split("-")[0],
    ...
    m = p ? "bottom" : "right",
    h = k(o)[d];
  r[m] - h < i[a] && (e.offsets.popper[a] -= i[a] - (r[m] - h)),
    r[a] + h > i[m] && (e.offsets.popper[a] += r[a] + h - i[m]),
  ...
  return (
    ...
    (e.arrowElement = o),
    (e.offsets.arrow = { [a]: Math.round(w), [l]: "" }),
    e
  );
}
function pe(e) {
  ...
  return (
    p.forEach((d, s) => {
      ...
      const f = e.offsets.popper,
        ...
        l = Math.floor,
        m =
          ("left" === n && l(f.right) > l(a.left)) ||
          ("right" === n && l(f.left) < l(a.right)) ||
          ("top" === n && l(f.bottom) > l(a.top)) ||
          ("bottom" === n && l(f.top) < l(a.bottom)),
        h = l(f.left) < l(o.left),
...
function ge(e, t) {
  ...
  const l = {
    primary(e) {
      let o = a[e];
      return (
        a[e] < s[e] && !t.escapeWithReference && (o = Math.max(a[e], s[e])),
        { [e]: o }
      );
    },
    secondary(e) {
      ...
      return (
        a[e] > s[e] &&
          ...
          (n = Math.min(a[o], s[e] - ("right" === e ? a.width : a.height))),
        { [o]: n }
      );
    }
  };
...
var Ee = {
    ...
    offset: { order: 200, enabled: !0, fn: ue, offset: 0 },
    preventOverflow: {
      order: 300,
      enabled: !0,
      fn: ge,
...
class ve {
  constructor(e, t, o = {}) {
    (this.scheduleUpdate = () => requestAnimationFrame(this.update)),
      ...
      (this.options = O({}, ve.Defaults, o)),
      (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
      (this.reference = e && e.jquery ? e[0] : e),
      (this.popper = t && t.jquery ? t[0] : t),
      (this.options.modifiers = {}),
      Object.keys(O({}, ve.Defaults.modifiers, o.modifiers)).forEach(e => {
        this.options.modifiers[e] = O(
          {},
          ve.Defaults.modifiers[e] || {},
