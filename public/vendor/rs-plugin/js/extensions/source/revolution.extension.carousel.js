...
(function($) {
  ...
  jQuery.extend(true, _R, {
    ...
    prepareCarousel: function(opt, a, direction, speed) {
      ...
      direction = opt.carousel.lastdirection = dircheck(
        direction,
        opt.carousel.lastdirection
      );
      ...
      if (speed !== undefined) {
        ...
        if (a == undefined) _R.carouselToEvalPosition(opt, direction);
        else animateCarousel(opt, direction, false);
      }
    },
    ...
    carouselToEvalPosition: function(opt, direction) {
      ...
      var bb =
          _.horizontal_align === "center"
            ? (_.wrapwidth / 2 - _.slide_width / 2 - _.slide_globaloffset) /
              _.slide_width
      ...
      calc =
        (cm >= 0.3 && direction === "left") ||
        (cm >= 0.7 && direction === "right")
          ? mc
          : (cm < 0.3 && direction === "left") ||
            (cm < 0.7 && direction === "right")
          ? mf
    ...
    organiseCarousel: function(opt, direction, setmaind, unli) {
      direction =
        ...
        direction == "up" ||
        direction === null ||
        jQuery.isEmptyObject(direction)
          ? "left"
          : direction;
      var _ = opt.carousel,
      ...
      for (var i = 0; i < len; i++) {
        ...
        if (_.infinity === "on") {
          pos =
            pos > _.wrapwidth - _.inneroffset && direction == "right"
              ? _.slide_offset - (_.slides.length - i) * _.slide_width
              : pos;
          pos =
            pos < 0 - _.inneroffset - _.slide_width && direction == "left"
              ? pos + _.maxwidth
              : pos;
        }
      ...
      if (_.slides)
        jQuery.each(_.slides, function(i, slide) {
          ...
          if (_.infinity === "on") {
            pos =
              pos > _.wrapwidth - _.inneroffset && direction === "left"
                ? slidepositions[0] - (len - i) * _.slide_width
                : pos;
            pos =
              pos < 0 - _.inneroffset - _.slide_width
                ? direction == "left"
                  ? pos + _.maxwidth
                  : direction === "right"
          ...
          var d =
              _.horizontal_align === "center"
                ? (Math.abs(_.wrapwidth / 2) - (tr.left + _.slide_width / 2)) /
                  _.slide_width
          ...
          if (_.fadeout === "on")
            if (_.vary_fade === "on")
              tr.autoAlpha =
                1 - Math.abs((1 / Math.ceil(_.maxVisibleItems / ha)) * d);
            else
              switch (_.horizontal_align) {
                case "center":
                  tr.autoAlpha =
                    Math.abs(d) < Math.ceil(_.maxVisibleItems / ha - 1)
                      ? 1
                      : 1 - (Math.abs(d) - Math.floor(Math.abs(d)));
                  break;
                case "left":
                  tr.autoAlpha =
                    d < 1 && d > 0
                      ? 1 - d
                      : Math.abs(d) > _.maxVisibleItems - 1
                      ? 1 - (Math.abs(d) - (_.maxVisibleItems - 1))
                      : 1;
                  break;
                case "right":
                  tr.autoAlpha =
            ...
            tr.autoAlpha =
              Math.abs(d) < Math.ceil(_.maxVisibleItems / ha) ? 1 : 0;
          ...
          if (_.minScale !== undefined && _.minScale > 0) {
            if (_.vary_scale === "on") {
              tr.scale =
                1 -
                Math.abs(
                  (_.minScale / 100 / Math.ceil(_.maxVisibleItems / ha)) * d
                );
              ...
              tr.scale =
                d >= 1 || d <= -1
                  ? 1 - _.minScale / 100
                  : (100 - _.minScale * Math.abs(d)) / 100;
              var sx =
                (_.slide_width - _.slide_width * (1 - _.minScale / 100)) *
                Math.abs(d);
            }
          }
          ...
          if (_.maxRotation !== undefined && Math.abs(_.maxRotation) != 0) {
            if (_.vary_rotation === "on") {
              ...
              tr.rotationY =
                d >= 1 || d <= -1 ? _.maxRotation : Math.abs(d) * _.maxRotation;
            }
          ...
          // TRANSFORM STYLE
          tr.transformStyle =
            opt.parallax.type != "3D" && opt.parallax.type != "3d"
              ? "flat"
              : "preserve-3d";
...
***************************************************/
  ...
  var defineCarouselElements = function(opt) {
    ...
    if (_.border_radius !== undefined && parseInt(_.border_radius, 0) > 0) {
      punchgs.TweenLite.set(opt.c.find(".tp-revslider-slidesli"), {
        borderRadius: _.border_radius
      });
    }
  };
  ...
  var setCarouselDefaults = function(opt) {
    ...
    _.wrapwidth =
      _.maxVisibleItems * _.slide_width + (_.maxVisibleItems - 1) * _.space;
    _.wrapwidth =
      opt.sliderLayout != "auto"
        ? _.wrapwidth > opt.c.closest(".tp-simpleresponsive").width()
          ? opt.c.closest(".tp-simpleresponsive").width()
          : _.wrapwidth
        : _.wrapwidth > opt.ul.width()
        ? opt.ul.width()
        : _.wrapwidth;
    ...
    _.wrapoffset =
      _.horizontal_align === "center"
        ? (opt.c.width() - roff - loff - _.wrapwidth) / 2
        : 0;
    _.wrapoffset =
      opt.sliderLayout != "auto" && opt.outernav
        ? 0
        : _.wrapoffset < loff
        ? loff
        : _.wrapoffset;
    ...
    _.inneroffset =
      _.horizontal_align === "right" ? _.wrapwidth - _.slide_width : 0;
  ...
  var dircheck = function(d, b) {
    return d === null || jQuery.isEmptyObject(d)
      ? b
      : d === undefined
      ? "right"
      : d;
  ...
  var breduc = function(a, m) {
    return Math.abs(a) > Math.abs(m)
      ? a > 0
        ? a - Math.abs(Math.floor(a / m) * m)
        : a + Math.abs(Math.floor(a / m) * m)
      : a;
  };
  ...
  var getActiveCarouselOffset = function(opt) {
    ...
    if (_.slide_globaloffset == "none")
      _.slide_globaloffset = ret =
        _.horizontal_align === "center"
          ? _.wrapwidth / 2 - _.slide_width / 2
          : 0;
    else {
      ...
      ret =
        _.infinity === "off"
          ? fi - ci
          : -getBestDirection(fi, ci, opt.slideamount);
