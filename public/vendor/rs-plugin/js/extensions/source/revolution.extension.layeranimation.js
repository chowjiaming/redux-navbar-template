  ...
  jQuery.extend(true, _R, {
    updateMarkup: function(layer, o) {
      ...
      if (d.start !== undefined && !d.frames_added && d.frames === undefined) {
        ...
        if (
          jQuery.isNumeric(d.end) &&
          jQuery.isNumeric(d.start) &&
          jQuery.isNumeric(oin.speed)
        ) {
          d.end =
            parseInt(d.end, 0) -
            (parseInt(d.start, 0) + parseFloat(oin.speed, 0));
        }
      ...
      if (!d.frames_added) {
        ...
        if (d.frames !== undefined) {
          for (var i = 0; i < d.frames.length; i++) {
            ...
            if (
              d.frames[i].sfx_effect !== undefined &&
              d.frames[i].sfx_effect.indexOf("block") >= 0
            ) {
              if (i === 0) {
                d.frames[i].from = "o:0";
                d.frames[i].to = "o:1";
            ...
            if (d.frames[i].frame === "hover") d.hoverframeindex = i;
            else if (
              d.frames[i].frame === "frame_999" ||
              d.frames[i].frame === "frame_out" ||
              d.frames[i].frame === "last" ||
              d.frames[i].frame === "end"
            )
              d.outframeindex = i;

            if (
              d.frames[i].split !== undefined &&
              d.frames[i].split.match(/chars|words|lines/g)
            )
              d.splittext = true;
          }
        }
      ...
      if (t != undefined && t != "none")
        if (ap == true || ap == "true" || ap == "on" || ap == "1sttime" || an) {
          if (
            ...
            (opt.sliderType === "carousel" &&
              opt.carousel.showLayersAllTime === "on" &&
              _nc.closest("li").hasClass("active-revslide")) ||
            (opt.sliderType === "carousel" &&
              opt.carousel.showLayersAllTime !== "on" &&
              _nc.closest("li").hasClass("active-revslide"))
          )
	...
	*************************************/
    ...
    animateTheCaptions: function(obj) {
      ...
      var _actli =
        opt.nextSlide === -1 || opt.nextSlide === undefined ? 0 : opt.nextSlide;
      if (opt.rowzones !== undefined)
        _actli = _actli > opt.rowzones.length ? opt.rowzones.length : _actli;
      if (
        opt.rowzones != undefined &&
        opt.rowzones.length > 0 &&
        opt.rowzones[_actli] != undefined &&
        _actli >= 0 &&
        _actli <= opt.rowzones.length &&
        opt.rowzones[_actli].length > 0
      )
        _R.setSize(opt);
          ...
          if (opt.timelines.staticlayers)
            jQuery.each(opt.timelines.staticlayers.layers, function(key, o) {
              var _ = o.layer.data(),
                ...
                triggered_out =
                  _.frames[_.frames.length - 1].delay === "bytrigger",
              ...
              if (in_v_range) {
                if (isvisible) {
                  ...
                  if (
                    (layer_start_status == "visible" &&
                      triggerstate !== "keep") ||
                    (triggerstate === "keep" && isvisible === true) ||
                    (layer_start_status == "visible" && isvisible === undefined)
                  ) {
	...
	********************************************/
    ...
    prepareSingleCaption: function(obj) {
      ...
      (_._lig =
        _._lig === undefined
          ? _nc.hasClass("rev_layer_in_group")
            ? _nc.closest(".rev_group")
            : _nc.hasClass("rev_layer_in_column")
            ? _nc.closest(".rev_column_inner")
            : _nc.hasClass("rev_column_inner")
            ? _nc.closest(".rev_row")
            : "none"
          : _._lig),
        (_._column =
        ...
        (_._row =
          _._row === undefined
            ...
            : _._row),
        (_._ingroup =
          _._ingroup === undefined
            ? !_nc.hasClass("rev_group") && _nc.closest(".rev_group")
              ? true
              : false
            : _._ingroup);
      _._isgroup =
        _._isgroup === undefined
          ? _nc.hasClass("rev_group")
            ? true
            : false
          : _._isgroup;
      _._nctype = _.type || "none";
      _._cbgc_auto =
        _._cbgc_auto === undefined
          ? _._nctype === "column"
            ? _._pw.find(".rev_column_bg_auto_sized")
            : false
          : _._cbgc_auto;
      _._cbgc_man =
        _._cbgc_man === undefined
          ? _._nctype === "column"
            ? _._pw.find(".rev_column_bg_man_sized")
            : false
          : _._cbgc_man;
      _._slideid =
        _._slideid || _nc.closest(".tp-revslider-slidesli").data("index");
      _._id = _._id === undefined ? _nc.data("id") || _nc.attr("id") : _._id;
      _._slidelink =
        _._slidelink === undefined
          ? _nc.hasClass("slidelink") === undefined
            ? false
            : _nc.hasClass("slidelink")
          : _._slidelink;
      ...
      if (opt.sliderLayout == "fullscreen")
        obj.offsety =
          _._gh / 2 - (opt.gridheight[opt.curWinRange] * opt.bh) / 2;
      ...
      if (
        ...
        obj.offsety =
          opt.conh / 2 - (opt.gridheight[opt.curWinRange] * opt.bh) / 2;
      ...
      if (opt.debugMode) {
        _nc
          .closest("li")
          .find(".helpgrid")
          .css({ top: obj.offsety + "px", left: obj.offsetx + "px" });
      ...
      var handlecaption = 0,
        layervisible =
          _.visibility === undefined
            ? "oon"
            : makeArray(_.visibility, opt)[opt.forcedWinRange] ||
              makeArray(_.visibility, opt) ||
              "ooon";

      // HIDE CAPTION IF RESOLUTION IS TOO LOW
      if (
        layervisible === "off" ||
        (_._gw < opt.hideCaptionAtLimit && _.captionhidden == "on") ||
        _._gw < opt.hideAllCaptionAtLimit
      )
        _._pw.addClass("tp-hidden-caption");
      else _._pw.removeClass("tp-hidden-caption");
      ...
      if (_nc.find("img").length > 0) {
        ...
        if (ww === "full-proportional") {
          ...
          ww = wful
            ? fuw
            : !jQuery.isNumeric(ww) && ww.indexOf("%") > 0
            ? ww
            : parseFloat(ww);
          hh = hful
            ? fuh
            : !jQuery.isNumeric(hh) && hh.indexOf("%") > 0
            ? hh
            : parseFloat(hh);
        }
        ...
        if (_._responsive !== "off") {
          if (_._ba != "grid" && wful)
            if (jQuery.isNumeric(ww)) im.css({ width: ww + "px" });
            else im.css({ width: ww });
          else if (jQuery.isNumeric(ww)) im.css({ width: ww * opt.bw + "px" });
          else im.css({ width: ww });

          if (_._ba != "grid" && hful)
            if (jQuery.isNumeric(hh)) im.css({ height: hh + "px" });
            else im.css({ height: hh });
          else if (jQuery.isNumeric(hh)) im.css({ height: hh * opt.bh + "px" });
          else im.css({ height: hh });
        } else {
      ...
      if (_._ba === "slide") {
        ...
        if (
          _._isstatic &&
          opt.carousel !== undefined &&
          opt.carousel.horizontal_align !== undefined &&
          opt.sliderType === "carousel"
        ) {
          switch (opt.carousel.horizontal_align) {
            case "center":
              obj.offsetx =
                0 + (opt.ulw - opt.gridwidth[opt.curWinRange] * opt.bw) / 2;
      ...
      if (
        ...
        _nc.hasClass("tp-audiolayer") ||
        _nc.find("iframe").length > 0 ||
        _nc.find(tag).length > 0
      ) {
        _.layertype = "video";
        if (_R.manageVideoLayer)
          _R.manageVideoLayer(_nc, opt, recall, internrecall);
        ...
        if (
          ...
          (_.forcecover != 1 && !_nc.hasClass("fullscreenvideo") && !yvcover)
        ) {
          im.width(ww);
          im.height(hh);
        }
        ...
        if (_._ingroup) {
          if (
            _.videowidth !== null &&
            _.videowidth !== undefined &&
            !jQuery.isNumeric(_.videowidth) &&
            _.videowidth.indexOf("%") > 0
          )
            punchgs.TweenLite.set([_._lw, _._pw, _._mw], {
              minWidth: _.videowidth
            });
        }
      ...
      _.arrobj = new Object();
      _.arrobj.voa =
        makeArray(_.voffset, opt)[opt.curWinRange] ||
        makeArray(_.voffset, opt)[0];
      _.arrobj.hoa =
        makeArray(_.hoffset, opt)[opt.curWinRange] ||
        makeArray(_.hoffset, opt)[0];
      _.arrobj.elx =
        makeArray(_.x, opt)[opt.curWinRange] || makeArray(_.x, opt)[0];
      _.arrobj.ely =
        makeArray(_.y, opt)[opt.curWinRange] || makeArray(_.y, opt)[0];
      ...
      var vofs =
          _._respoffset !== "off"
            ? parseInt(voa, 0) * opt.bw
            : parseInt(voa, 0),
        hofs =
          _._respoffset !== "off"
            ? parseInt(hoa, 0) * opt.bw
            : parseInt(hoa, 0),
        crw =
          _._ba === "grid" ? opt.gridwidth[opt.curWinRange] * opt.bw : _._gw,
        crh =
          _._ba === "grid" ? opt.gridheight[opt.curWinRange] * opt.bw : _._gh;
      ...
      if (_.loopanimation == "on")
        punchgs.TweenLite.set(_._lw, { minWidth: _.eow, minHeight: _.eoh });

      //Preset Position of BG
      if (_._nctype === "column") {
        var tempy =
            _nc[0]._gsTransform !== undefined ? _nc[0]._gsTransform.y : 0,
          pT = parseInt(_._column[0].style.paddingTop, 0);
        punchgs.TweenLite.set(_nc, { y: 0 });
        punchgs.TweenLite.set(_._cbgc_man, {
          y: parseInt(pT + _._column.offset().top - _nc.offset().top, 0)
        });
	...
	********************************************/
    ...
    createTimelineStructure: function(opt) {
      ...
      function addTimeLineWithLabel(layer, opt, parentobject, slideid) {
        ...
        parentobject[layer.attr("id")] =
          parentobject[layer.attr("id")] || new Object();
        ...
        parentobject[layer.attr("id")].wrapper =
          c.indexOf("rev_layer_in_column") >= 0
            ? layer.closest(".rev_column_inner")
            : c.indexOf("rev_column_inner") >= 0
            ? layer.closest(".rev_row")
            : c.indexOf("rev_layer_in_group") >= 0
            ? layer.closest(".rev_group")
            : "none";
        parentobject[layer.attr("id")].timeline = timeline;
        parentobject[layer.attr("id")].layer = layer;
        parentobject[layer.attr("id")].triggerstate = layer.data(
          "lasttriggerstate"
        );
        parentobject[layer.attr("id")].dchildren =
          c.indexOf("rev_row") >= 0
            ? layer[0].getElementsByClassName("rev_column_inner")
            : c.indexOf("rev_column_inner") >= 0
            ? layer[0].getElementsByClassName("tp-caption")
            : c.indexOf("rev_group") >= 0
            ? layer[0].getElementsByClassName("rev_layer_in_group")
            : "none";
      ...
      opt.c.find(".tp-revslider-slidesli, .tp-static-layers").each(function() {
        ...
        opt.timelines[index].layers =
          opt.timelines[index].layers || new Object();

        // COLLECT LAYERS
        slide.find(".tp-caption").each(function(i) {
          addTimeLineWithLabel(
            jQuery(this),
            opt,
            opt.timelines[index].layers,
            index
	...
	***************************************/
    buildFullTimeLine: function(obj) {
      ...
      if (_.hoverframeindex !== -1 && _.hoverframeindex !== undefined) {
        if (!_nc.hasClass("rs-hover-ready")) {
          ...
          _.hoveranim = convertHoverStyle(
            _.hoveranim,
            _.frames[_.hoverframeindex].style
          );

          if ($svg.svg) {
            var $svghover = setSVGAnimObject(
              _.svg_hover,
              newSVGHoverAnimObject()
            );
          ...
          _nc.hover(
            function(e) {
              ...
              if (animended) {
                _.hovertimelines.item = punchgs.TweenLite.to(
                  nc,
                  frame.speed / 1000,
                  _.hoveranim.anim
                );
                if (
                  _.hoverzIndex ||
                  (_.hoveranim.anim && _.hoveranim.anim.zIndex)
                ) {
                  _.basiczindex =
                    _.basiczindex === undefined
                      ? _.cssobj.zIndex
                      : _.basiczindex;
                  _.hoverzIndex =
                    _.hoverzIndex === undefined
                      ? _.hoveranim.anim.zIndex
                      : _.hoverzIndex;
                  _.inhoverinanimation = true;
                  if (frame.speed === 0) _.inhoverinanimation = false;

                  _.hovertimelines.pwhoveranim = punchgs.TweenLite.to(
                    _._pw,
                    frame.speed / 1000,
                    { overwrite: "auto", zIndex: _.hoverzIndex }
                  );
                  _.hovertimelines.pwhoveranim.eventCallback(
                    "onComplete",
                    function(_) {
                ...
                if ($svg.svg)
                  _.hovertimelines.svghoveranim = punchgs.TweenLite.to(
                    [$svg.svg, $svg.svg.find("path")],
                    frame.speed / 1000,
                    _.hoversvg.anim
                  );
            ...
            function(e) {
              ...
              if (animended) {
                ...
                _.hovertimelines.item = punchgs.TweenLite.to(
                  nc,
                  frame.speed / 1000,
                  jQuery.extend(true, {}, _._gsTransformTo)
                );

                if (frame.speed == 0) _.inhoveroutanimation = false;
                _.hovertimelines.item.eventCallback(
                  "onComplete",
                  function(_) {
                ...
                if (_.hovertimelines.pwhoveranim !== undefined)
                  _.hovertimelines.pwhoveranim = punchgs.TweenLite.to(
                    _._pw,
                    frame.speed / 1000,
                    { overwrite: "auto", zIndex: _.basiczindex }
                  );
                if ($svg.svg)
      ...
      for (var frame_index = 0; frame_index < _.frames.length; frame_index++) {
        if (frame_index !== _.hoverframeindex) {
          ...
          var frame_name =
            frame_index === _.inframeindex
              ? "frame_0"
              : frame_index === _.outframeindex ||
                _.frames[frame_index].frame === "frame_999"
              ? "frame_999"
              : "frame_" + frame_index;
          _.frames[frame_index].framename = frame_name;

          _nc_tl_obj[frame_name] = {};
          _nc_tl_obj[frame_name].timeline = new punchgs.TimelineLite({
            align: "normal"
          });
          ...
          var $start = _.frames[frame_index].delay,
            ...
            mdelay =
              $start !== undefined
                ? jQuery.inArray($start, ["slideenter", "bytrigger", "wait"]) >=
                  0
                  ? $start
                  : parseInt($start, 0) / 1000
                : "wait";

          // ADD STARTLABEL FOR STATIC LAYERS
          if (_nc_tl_obj.firstslide !== undefined && frame_name === "frame_0") {
            _nc_timeline.addLabel(
              "slide_" + _nc_tl_obj.firstslide + "_pause",
              0
            );
          ...
          if (
            _nc_tl_obj.lastslide !== undefined &&
            frame_name === "frame_999"
          ) {
            _nc_timeline.addLabel(
              "slide_" + _nc_tl_obj.lastslide + "_pause",
              "+=0.01"
            );
      ...
      if (!obj.regenerate) {
        ...
        else _nc_timeline.time(_.current_timeline_time);
      }
    ...
    createFrameOnTimeline: function(obj) {
      ...
      if (_.hoverframeindex !== -1 && _.hoverframeindex == verylastframe)
        verylastframe = verylastframe - 1;
      ...
      if (_._nctype === "column") {
        timeline.add(
          punchgs.TweenLite.set(_._cbgc_man, { visibility: "visible" }),
          label
        );
        timeline.add(
          punchgs.TweenLite.set(_._cbgc_auto, { visibility: "hidden" }),
          label
        );
      }
      ...
      if (
        _.mySplitText !== undefined &&
        $split &&
        $split.match(/chars|words|lines/g)
      ) {
      ...
      var $to =
          frame_index !== _.outframeindex
            ...
            : _.frames[frame_index].to !== undefined &&
              _.frames[frame_index].to.match(/auto:auto/g) === null
            ? getAnimDatas(
                newEndAnimObject(),
                _.frames[frame_index].to,
                opt.sdir == 1,
            ...
            : getAnimDatas(
                newEndAnimObject(),
                _.frames[_.inframeindex].from,
                opt.sdir == 0,
                $splitnow,
                animobject.length - 1
              ),
        $from =
          _.frames[frame_index].from !== undefined
            ? getAnimDatas(
                $to,
                _.frames[_.inframeindex].from,
                opt.sdir == 1,
            ...
            : undefined, // ANIMATE FROM THE VERY FIRST SETTING, OR FROM PREVIOUS SETTING
      ...
      else $mask_to = getMaskDatas(_.frames[frame_index].mask);

      $to.anim.ease =
        _.frames[frame_index].ease === undefined
          ? punchgs.Power1.easeInOut
          : _.frames[frame_index].ease;
      ...
      if ($from !== undefined) {
        $from.anim.ease =
          _.frames[frame_index].ease === undefined
            ...
            : _.frames[frame_index].ease;
        $from.speed =
          _.frames[frame_index].speed === undefined
            ? $from.speed
            : _.frames[frame_index].speed;
        $from.anim.x =
          $from.anim.x * opt.bw ||
          getBorderDirections(
            $from.anim.x,
      ...
      if (_nc.data("iframes"))
        timeline.add(
          punchgs.TweenLite.set(_nc.find("iframe"), { autoAlpha: 1 }),
          label + "+=0.001"
        );
      ...
      if (frame_index === _.outframeindex) {
        if (
          _.frames[frame_index].to &&
          _.frames[frame_index].to.match(/auto:auto/g)
        ) {
          //
        }
        ...
        $to.speed =
          _.frames[frame_index].speed === undefined ||
          _.frames[frame_index].speed === "inherit"
            ? _.frames[_.inframeindex].speed
            : _.frames[frame_index].speed;
        $to.anim.ease =
          _.frames[frame_index].ease === undefined ||
          _.frames[frame_index].ease === "inherit"
            ? _.frames[_.inframeindex].ease
            : _.frames[frame_index].ease;
      ...
      if (frame_index === 0 && !obj.fromcurrentstate) {
        if (animobject != _nc) {
          ...
          if (old["-webkit-filter"] !== undefined)
            $to.anim["-webkit-filter"] = old["-webkit-filter"];
        }
      ...
      if (
        ...
        var $sfx_speed =
            frame_index === 0 ? $from.speed / 1000 / 2 : $to.speed / 1000 / 2,
          $sfx_ft = [
            { scaleY: 1, scaleX: 0, transformOrigin: "0% 50%" },
            { scaleY: 1, scaleX: 1, ease: $to.anim.ease }
          ],
          $sfx_t = {
            scaleY: 1,
            scaleX: 0,
        ...
        $sfx_blockdelay =
          $elemdelay === undefined ? $sfx_speed : $elemdelay + $sfx_speed;
        ...
        switch ($sfx) {
          ...
          case "blocktobottom":
            $sfx_ft = [
              ...
              { scaleX: 1, scaleY: 1, ease: $to.anim.ease }
            ];
            $sfx_t = {
              scaleX: 1,
              scaleY: 0,
        ...
        timeline.add(
          tweens.mask.to(_._bmask, $sfx_speed, $sfx_t, $sfx_blockdelay),
          label
        );
      }
      ...
      if (frame_index === 0 && !obj.fromcurrentstate) {
        if (_._sfx_in === "block")
          timeline.add(
            tweens.content.staggerFromTo(
              animobject,
              0.05,
              { x: 0, y: 0, autoAlpha: 0 },
              { x: 0, y: 0, autoAlpha: 1, delay: $sfx_blockdelay }
            ),
            label
          );
        else {
          if ($splitnow && ri !== undefined) {
            var cycles = {
              from: getCycles($from.anim),
              to: getCycles($to.anim)
            };
            ...
            for (var si in animobject) {
              ...
              for (var k in cycles.from) {
                $fanim[k] = parseInt(
                  cycles.from[k].values[cycles.from[k].index],
                  0
                );
                cycles.from[k].index =
                  cycles.from[k].index < cycles.from[k].len
                    ? cycles.from[k].index + 1
                    : 0;
              }
              ...
              if (_.frames[frame_index].bgcolor !== undefined) {
                ...
                $tanim.backgroundColor =
                  _.cssobj.styleProps["background-color"];
              }
              timeline.add(
                tweens.content.fromTo(
                  animobject[ri[si]],
                  $from.speed / 1000,
                  $fanim,
                  $tanim,
        ...
        if (_._sfx_out === "block" && frame_index === _.outframeindex) {
          timeline.add(
            tweens.content.staggerTo(animobject, 0.001, {
              autoAlpha: 0,
          ...
          timeline.add(
            tweens.content.staggerTo(animobject, $to.speed / 1000 / 2 - 0.001, {
              x: 0,
              delay: $sfx_blockdelay
            }),
            label + "+=0.001"
          ...
          for (var si in animobject) {
            ...
            for (var k in cycles.to) {
              ...
              cycles.to[k].index =
                cycles.to[k].index < cycles.to[k].len
                  ? cycles.to[k].index + 1
                  : 0;
            }
            if (_.frames[frame_index].color !== undefined)
      ...
      if (
        $mask_to !== undefined &&
        $mask_to !== false &&
        (frame_index !== 0 || !obj.ignorefirstframe)
      ) {
        $mask_to.anim.ease =
          $mask_to.anim.ease === undefined || $mask_to.anim.ease === "inherit"
            ? _.frames[0].ease
            : $mask_to.anim.ease;
      ...
      if (
        ...
        timeline.add(
          tweens.mask.to(_._mw, $to.speed / 1000, $mask_to.anim, $elemdelay),
          label
        );
      ...
      // ON START
      tweens.content.eventCallback("onStart", tweenOnStart, [
        frame_index,
        _nc_tl_obj,
        _._pw,
        _,
        ...
        $to.anim,
        _nc,
        obj.updateStaticTimeline,
        opt
      ]);

      // ON UPDATE
      tweens.content.eventCallback("onUpdate", tweenOnUpdate, [
        label,
        _._id,
        _._pw,
        _,
      ...
      // ON COMPLETE
      tweens.content.eventCallback("onComplete", tweenOnComplete, [
        frame_index,
        _.frames.length,
        verylastframe,
        _._pw,
    ...
    endMoveCaption: function(obj) {
      ...
      if (obj.frame !== undefined) nc.timeline.play(obj.frame);
      else if (
        !nc.static ||
        obj.currentslide >= nc.removeonslide ||
        obj.currentslide < nc.showonslide
      ) {
      ...
      if (obj.checkchildrens)
        if (
          nc.timeline_obj &&
          nc.timeline_obj.dchildren &&
          nc.timeline_obj.dchildren !== "none" &&
          nc.timeline_obj.dchildren.length > 0
        )
          for (var q = 0; q < nc.timeline_obj.dchildren.length; q++) {
            _R.endMoveCaption({
              caption: jQuery(nc.timeline_obj.dchildren[q]),
              opt: obj.opt
            });
          }
    },
...
**********************************************************************************************/
  ...
  var tweenOnStart = function(
    ...
    if (
      ncobj.dchildren !== "none" &&
      ncobj.dchildren !== undefined &&
      ncobj.dchildren.length > 0
    ) {
      if (frame_index === 0)
        for (var q = 0; q < ncobj.dchildren.length; q++) {
          jQuery(ncobj.dchildren[q])
            .data("timeline")
            .play(0);
        }
        ...
        for (var q = 0; q < ncobj.dchildren.length; q++) {
          _R.endMoveCaption({
            caption: jQuery(ncobj.dchildren[q]),
            opt: opt,
            checkchildrens: true
          });
        }
  ...
  var tweenOnUpdate = function(
    ...
    if (_.hoveranim !== undefined && _._gsTransformTo === false) {
      ...
      if (_._gsTransformTo && _._gsTransformTo.startAt)
        delete _._gsTransformTo.startAt;

      if (_.cssobj.styleProps.css === undefined)
        _._gsTransformTo = jQuery.extend(
          true,
          {},
          _.cssobj.styleProps,
          _._gsTransformTo
  ...
  var tweenOnComplete = function(
    ...
    data.eventtype =
      frame_index === 0
        ? "enteredstage"
        : frame_index === frame_max - 1 || frame_index === verylastframe
        ? "leftstage"
        : "frameended";
    data.layertype = _nc.data("layertype");
    data.layersettings = _nc.data();
    ...
    if (data.eventtype === "leftstage") {
      ...
      if (_._nctype === "video" && _R.resetVideo)
        setTimeout(function() {
  ...
  var getTLInfos = function(obj) {
    ...
    _.slideid =
      obj.caption.data("slideid") ||
      obj.caption.closest(".tp-revslider-slidesli").data("index");
    ...
    _.static =
      _.timeline_obj.firstslide != undefined ||
      _.timeline_obj.lastslide != undefined;
    if (_.static) {
  ...
  var newAnimObject = function(a) {
    ...
    a.anim.transformOrigin =
      a.anim.transformOrigin === undefined ? "50% 50%" : a.anim.transformOrigin;
    a.anim.transformPerspective =
      a.anim.transformPerspective === undefined
        ? 600
        : a.anim.transformPerspective;
    ...
    a.anim.visibility =
      a.anim.visibility === undefined ? "visible" : a.anim.visibility;
    a.anim.overwrite =
      a.anim.overwrite === undefined ? "auto" : a.anim.overwrite;
  ...
  var animDataTranslator = function(val, defval, $split, $splitamount, ext) {
    ...
    if (jQuery.isNumeric(parseFloat(val))) {
      ...
      if ($split !== undefined && $splitamount !== undefined) {
        val ==
          "[" +
            (parseInt(Math.random() * (max - min), 0) + parseInt(min, 0)) +
            "ext";
    ...
    if (customarray)
      jQuery.each(customarray, function(index, pa) {
        ...
        if (v != undefined) {
          ...
          if (w == "rotationX" || w == "rX")
            o.anim.rotationX = animDataTranslator(
              v,
              o.anim.rotationX,
              $split,
              $splitamount,
          ...
          if (w == "rotationY" || w == "rY")
            o.anim.rotationY = animDataTranslator(
              v,
              o.anim.rotationY,
              $split,
              $splitamount,
          ...
          if (w == "rotationZ" || w == "rZ")
            o.anim.rotation = animDataTranslator(
              v,
              o.anim.rotationZ,
              $split,
              $splitamount,
          ...
          if (w == "scaleX" || w == "sX")
            o.anim.scaleX = animDataTranslator(
              v,
              o.anim.scaleX,
              $split,
              $splitamount
          ...
          if (w == "scaleY" || w == "sY")
            o.anim.scaleY = animDataTranslator(
              v,
              o.anim.scaleY,
              $split,
              $splitamount
          ...
          if (w == "opacity" || w == "o")
            o.anim.opacity = animDataTranslator(
              v,
              o.anim.opacity,
              $split,
              $splitamount
          ...
          if (w == "fb")
            tmpf =
              tmpf === ""
                ? "blur(" + parseInt(v, 0) + "px)"
                : tmpf + " " + "blur(" + parseInt(v, 0) + "px)";
          if (w == "fg")
            tmpf =
              tmpf === ""
                ? "grayscale(" + parseInt(v, 0) + "%)"
                : tmpf + " " + "grayscale(" + parseInt(v, 0) + "%)";
          if (w == "fbr")
            tmpf =
              tmpf === ""
                ? "brightness(" + parseInt(v, 0) + "%)"
                : tmpf + " " + "brightness(" + parseInt(v, 0) + "%)";
          ...
          if (w == "skewX" || w == "skX")
            o.anim.skewX = animDataTranslator(
              v,
              o.anim.skewX,
              $split,
              $splitamount
          ...
          if (w == "skewY" || w == "skY")
            o.anim.skewY = animDataTranslator(
              v,
              o.anim.skewY,
              $split,
              $splitamount
          ...
          if (w == "x")
            o.anim.x = animDataTranslator(v, o.anim.x, $split, $splitamount);
          if (w == "y")
            o.anim.y = animDataTranslator(v, o.anim.y, $split, $splitamount);
          if (w == "z")
            o.anim.z = animDataTranslator(v, o.anim.z, $split, $splitamount);
  ...
  var convertHoverStyle = function(t, s) {
    ...
    if (sp)
      jQuery.each(sp, function(key, cont) {
        ...
        if (attr[0].length > 0) {
          if (
            attr[0] === "background-color" &&
            attr[1].indexOf("gradient") >= 0
          )
            attr[0] = "background";
  ...
  var getcssParams = function(nc, level) {
    ...
    obj.whiteSpace = gp
      ...
      : nc.data("whitespace");
    obj.textAlign = gp
      ? pc.data("textalign") === undefined
        ? pc.css("textalign") || "inherit"
        : pc.data("textalign")
      : nc.data("textalign") === undefined
      ? nc.css("textalign") || "inherit"
      : nc.data("textalign");
    obj.zIndex = gp
      ? pc.data("zIndex") === undefined
        ? pc.css("zIndex") || "inherit"
        : pc.data("zIndex")
      : nc.data("zIndex") === undefined
      ? nc.css("zIndex") || "inherit"
      : nc.data("zIndex");

    if (
      jQuery.inArray(nc.data("layertype"), ["video", "image", "audio"]) ===
        -1 &&
      !nc.is("img")
    )
      obj.lineHeight = gp
    ...
    if (level != "rekursive") {
      ...
      obj.maxWidth =
        nc.data("width") === undefined
          ...
          : nc.data("width");
      obj.maxHeight =
        jQuery.inArray(nc.data("type"), ["column", "row"]) !== -1
          ? "none"
          : nc.data("height") === undefined
    ...
    if (
      obj.styleProps.background === "" ||
      obj.styleProps.background === undefined ||
      obj.styleProps.background === obj.styleProps["background-color"]
    )
  ...
  var calcCaptionResponsive = function(nc, opt, level, responsive) {
    ...
    if (_._nctype === "column") {
      ...
      objmargins = { Top: 0, Bottom: 0, Left: 0, Right: 0 };
    }
    ...
    if (!nc.hasClass("tp-splitted")) {
      ...
      if (level != "rekursive") {
        ...
        if (_.svg_src != undefined) {
          var scolto =
            obj.color != "nopredefinedcolor" && obj.color != undefined
              ? obj.color
              : obj.css != undefined &&
                obj.css.color != "nopredefinedcolor" &&
                obj.css.color != undefined
              ? obj.css.color
              : obj.styleProps.color != undefined
              ? obj.styleProps.color
              : obj.styleProps.css != undefined &&
                obj.styleProps.css.color != undefined
              ? obj.styleProps.css.color
              : false;
          if (scolto != false) {
            punchgs.TweenLite.set(nc.find("svg"), {
              fill: scolto,
              overwrite: "auto"
            });
            punchgs.TweenLite.set(nc.find("svg path"), {
              fill: scolto,
              overwrite: "auto"
            });
          }
      ...
      if (_._nctype === "column") {
        if (_._column_bg_set === undefined) {
          ...
          _._column_bg_opacity =
            _._column_bg_opacity === undefined ? 1 : _._column_bg_opacity;
  ...
  var setColumnBgDimension = function(nc, opt) {
    ...
    if (_._cbgc_man && _._cbgc_man.length > 0) {
      ...
      _h = _._row.hasClass("rev_break_columns")
        ? "100%"
        : _._row.height() - (_t + _b) + "px";
    ...
    if (el.hasClass("rs-wave")) {
      if (_._loop_timeline == undefined) {
        ...
        var _ox = (parseInt(oo.x, 0) / 100 - 0.5) * el.width(),
          ...
          waveanim = new punchgs.TweenLite.fromTo(
            angobj,
            speed,
            { a: 0 + ang },
            { a: 360 + ang, force3D: "auto", ease: punchgs.Linear.easeNone }
          );
  ...
  var killCaptionLoops = function(nextcaption) {
    // SOME LOOPING ANIMATION ON INTERNAL ELEMENTS
    nextcaption
      .closest(".rs-pendulum, .rs-slideloop, .rs-pulse, .rs-wave")
      .each(function() {
        var _ = this;
        if (_._loop_timeline != undefined) {
