...
(function($) {
  ...
  var prepLayerAnimations = function(container, opt) {
    ...
    container.find(".tp-caption").each(function() {
      ...
      else if (ncc.match(/\bskewfromleftshort\b/))
        cp.data("transform_in", c.skewfromleftshort);
      else if (ncc.match(/\bskewfromrightshort\b/))
        cp.data("transform_in", c.skewfromrightshort);
      else if (ncc.match(/\bskewfromleft\b/))
        cp.data("transform_in", c.skewfromleft);
      else if (ncc.match(/\bskewfromright\b/))
        cp.data("transform_in", c.skewfromright);
      else if (ncc.match(/\bfade\b/)) cp.data("transform_in", c.fade);

      if (ncc.match(/\brandomrotateout\b/))
        cp.data("transform_out", c.randomrotate);
      ...
      else if (ncc.match(/\bskewtoleftshortout\b/))
        cp.data("transform_out", c.skewfromleftshort);
      else if (ncc.match(/\bskewtorightshortout\b/))
        cp.data("transform_out", c.skewfromrightshort);
      else if (ncc.match(/\bskewtoleftout\b/))
        cp.data("transform_out", c.skewfromleft);
      else if (ncc.match(/\bskewtorightout\b/))
        cp.data("transform_out", c.skewfromright);
      else if (ncc.match(/\bfadeout\b/)) cp.data("transform_out", c.fade);

      if (cp.data("customin") != undefined)
        cp.data("transform_in", cp.data("customin"));
      if (cp.data("customout") != undefined)
        cp.data("transform_out", cp.data("customout"));
    });
  };
})(jQuery);
