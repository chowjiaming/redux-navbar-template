...
(function($) {
  ...
  jQuery.extend(true, _R, {
    ...
    resetVideo: function(_nc, opt, preset, nextli) {
      ...
      switch (_.videotype) {
          ...
          try {
            if (_.forcerewind == "on") {
              ...
              var s = getStartSec(_nc.data("videostartat")),
                ...
                forceseek =
                  _.bgvideo === 1 || _nc.find(".tp-videoposter").length > 0
                    ? true
                    : false;
        ...
        case "html5":
          ...
          if (
            _.volume == "mute" ||
            _R.lastToggleState(_nc.videomutetoggledby) ||
            opt.globalmute === true
          )
            video.muted = true;
          break;
    ...
    prepareCoveredVideo: function(opt, _nc) {
      ...
      if (_nc.hasClass("tp-caption") && !_nc.hasClass("coverscreenvideo"))
        return;

      if (
        _nc.data("vimeoid") !== undefined &&
        _nc.data("vimeoplayerloaded") === undefined
      )
        return;
      ...
      var conw =
        opt.sliderType !== "carousel"
          ? opt.conw
          : _nc.closest(".tp-revslider-slidesli").width();
    ...
    manageVideoLayer: function(_nc, opt, recalled, internrecalled) {
      ...
      var _ = _nc.data(),
        ...
        videopreload =
          _.videopreload === "auto" ||
          _.videopreload === "canplay" ||
          _.videopreload === "canplaythrough" ||
          _.videopreload === "progress"
            ? "auto"
            : _.videopreload,
        videomp = _.videomp4,
        ...
        videoloop =
          _.videoloop == "loop"
            ? "loop"
            : _.videoloop == "loopandnoslidestop"
            ? "loop"
            : "",
        videotype =
      ...
      switch (newvideotype) {
        case "html5":
          ...
          if (tag === "video") {
            ...
            if (videomp != undefined)
              apptxt =
                apptxt + '<source src="' + videomp + '" type="audio/mpeg" />';
            if (videoogv != undefined)
              apptxt =
                apptxt + '<source src="' + videoogv + '" type="audio/ogg" />';
          }
          apptxt = apptxt + "</" + tag + ">";
          var hfm = "";
        ...
        case "youtube":
          ...
          if (
            ...
            _.videoinline === "true" ||
            _.videoinline === 1 ||
            _nc.hasClass("rs-background-video-layer") ||
      ...
      if (
        _.videoposter != undefined &&
        _.videoposter.length > 2 &&
        !noposteronmobile
      ) {
  ...
  var callPrepareCoveredVideo = function(opt, _nc) {
    ...
    if (_nc.data("bgvideo") == 1 || _nc.data("forcecover") == 1) {
      ...
      if (a === undefined && a.split(":").length <= 1)
        _nc.data("aspectratio", "16:9");
    ...
    if (_nc.data("videolistenerexist") !== 1) {
      switch (_.videotype) {
            ...
            events: {
                ...
                if (event.data == YT.PlayerState.PLAYING) {
                  ...
                  if (
                    ...
                    ((_nc.data("showcoveronpause") == "on" &&
                      _nc.find(".tp-videoposter").length > 0) ||
                      (_nc.data("bgvideo") === 1 &&
                        _nc.find(".rs-fullvideo-cover").length > 0))
                  ) {
                    if (_nc.data("bgvideo") === 1)
                      punchgs.TweenLite.to(
                        _nc.find(".rs-fullvideo-cover"),
                        0.1,
                        {
                          autoAlpha: 1,
                          force3D: "auto",
              ...
              onReady: function(event) {
                ...
                if (isVideoMobile || _R.isSafari11()) {
                  var isLayerAutoPlay =
                    isVideoLayer && _nc.data("autoplay") !== "off";
                  if (
                    _nc.hasClass("rs-background-video-layer") ||
                    isLayerAutoPlay
                  ) {
        ...
        case "vimeo":
          ...
          isAutoplay =
            isAutoplay === "on" || isAutoplay === "true" || isAutoplay === true;
          ...
          f.on("play", function(data) {
            ...
            if (!_nc.data("vimeoplaysinline")) {
              if (
                ...
                f.setVolume(0);
              else f.setVolume(parseInt(_nc.data("volume"), 0) / 100 || 0.75);
              _R.toggleState(_.videotoggledby);
            }
          });
          ...
          f.on("timeupdate", function(data) {
            ...
            if (
              et != 0 &&
              (Math.abs(et - data.seconds) < 1 && et > data.seconds) &&
  ...
  var htmlvideoevents = function(_nc, opt, startnow) {
    ...
    if (
      _nc.data("bgvideo") == 1 &&
      (_.videoloop === "none" || _.videoloop === false)
    )
      pforv = false;
