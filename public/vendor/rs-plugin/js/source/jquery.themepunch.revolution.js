...
(function(jQuery, undefined) {
      ...
      return this.each(function() {
        ...
        options.minHeight =
          options.minHeight != undefined
            ...
            : options.minHeight;
        options.scrolleffect.on =
          options.scrolleffect.fade === "on" ||
          options.scrolleffect.scale === "on" ||
          options.scrolleffect.blur === "on" ||
          options.scrolleffect.grayscale === "on";
  ...
  jQuery.extend(true, _R, {
      ...
      if (extension.check != "stop") {
        ...
        if (_R.getversion().core < extension.min_core) {
          if (extension.check === undefined) {
            console.log(
              "%c" +
                "Slider Revolution Warning (Core:" +
                _R.getversion().core +
                ")",
            ...
            console.log(
              "%c" +
                "     Please update Slider Revolution to the latest version.",
              "color:#333"
            );
            console.log(
              "%c" +
                "     It might be required to purge and clear Server/Client side Caches.",
              "color:#333"
            );
          }
          extension.check = "stop";
        } else if (
          _R.getversion()[extension.name] != undefined &&
          extension.version < _R.getversion()[extension.name]
        ) {
          if (extension.check === undefined) {
            console.log(
              "%c" +
	...
	*/
    isSafari11: function() {
      ...
      if (
        jQuery.trim(navigator.userAgent.toLowerCase()).search("edge") !== -1 ||
        browser === "msie"
      )
        return false;
    ...
    setSize: function(opt) {
      var ofh = (opt.top_outer || 0) + (opt.bottom_outer || 0),
        ...
        __mh = 0,
        _actli =
          opt.nextSlide === -1 || opt.nextSlide === undefined
            ? 0
            : opt.nextSlide;
      opt.paddings =
      ...
      if (opt.sliderLayout == "fullscreen" || opt.infullscreenmode) {
        ...
        opt.height =
          parseInt(__mh, 0) > parseInt(opt.height, 0) ? __mh : opt.height;
      } else {
        if (opt.minHeight != undefined && opt.height < opt.minHeight)
          opt.height = opt.minHeight;
        opt.height =
  ...
  var lAjax = function(s, o) {
    ...
    jQuery.ajax({
      url:
        o.jsFileLocation + s + o.extensions_suffix + "?version=" + version.core,
      dataType: "script",
      cache: true,
      error: function(e) {
  ...
  var getNeededScripts = function(o, c) {
    ...
    if (n.videos && typeof _R.isVideoPlaying == "undefined")
      lAjax("revolution.extension.video", o);
    if (n.carousel && typeof _R.prepareCarousel == "undefined")
      lAjax("revolution.extension.carousel", o);
    if (!n.carousel && typeof _R.animateSlide == "undefined")
      lAjax("revolution.extension.slideanims", o);
    if (n.actions && typeof _R.checkActions == "undefined")
      lAjax("revolution.extension.actions", o);
    if (n.layeranim && typeof _R.handleStaticLayers == "undefined")
      lAjax("revolution.extension.layeranimation", o);
    if (n.kenburns && typeof _R.stopKenBurn == "undefined")
      lAjax("revolution.extension.kenburn", o);
    if (n.navigation && typeof _R.createNavigation == "undefined")
      lAjax("revolution.extension.navigation", o);
    if (n.migration && typeof _R.migration == "undefined")
      lAjax("revolution.extension.migration", o);
    if (n.parallax && typeof _R.checkForParallax == "undefined")
      lAjax("revolution.extension.parallax", o);
  ...
  var runSlider = function(container, opt) {
      ...
      if (li.data("link") != undefined) {
        ...
        var apptxt =
          ...
          frame =
            " data-frames=" +
            "'" +
            '[{"delay":0,"speed":100,"frame":"0","from":"opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' +
            "'";
        apptxt =
          linktoslide == "no"
            ? apptxt + frame + " >"
            : apptxt + "data-actions=" + "'" + jts + "'" + frame + " >";
    ...
    if (!container.hasClass("revslider-initialised")) {
      ...
      container
        ...
        .each(function(i) {
          var _nc = jQuery(this),
            ...
            ap = _.autoplay,
            htmlvideo =
              _.videomp4 !== undefined ||
              _.videowebm !== undefined ||
              _.videoogv !== undefined,
          ...
          if (_nc.hasClass("tp-static-layer") && _R.handleStaticLayers) {
            ...
            if (opt.scrolleffect.on)
              if (
                (opt.scrolleffect.on_parallax_static_layers === "on" &&
                  _.isparallaxlayer) ||
                (opt.scrolleffect.on_static_layers === "on" &&
                  !_.isparallaxlayer)
              )
                addToStaticFadeout = true;
            addtofadeout = false;
          }
          ...
          if (_nc.hasClass("tp-caption")) {
            ...
            if (nctype === "row") {
              ...
              specec =
                _ndata.verticalalign === undefined
                  ? " vertical-align:bottom;"
                  : " vertical-align:" + _ndata.verticalalign + ";";
              preclas = "rev_column";
            ...
            if (_ndata.wrapper_class !== undefined)
              preclas = preclas + " " + _ndata.wrapper_class;
            if (_ndata.wrapper_id !== undefined)
              preid = 'id="' + _ndata.wrapper_id + '"';
            ...
            if (addtofadeout && opt.scrolleffect.on)
              if (
                (opt.scrolleffect.on_parallax_layers === "on" &&
                  _.isparallaxlayer) ||
                (opt.scrolleffect.on_layers === "on" && !_.isparallaxlayer)
              )
      ...
      if (
        (opt.parallax.type !== "off" || opt.scrolleffect.on) &&
        _R.checkForParallax
      )
...
**************************************/
  ...
  var checkHoverDependencies = function(_nc, opt) {
    var _ = _nc.data(),
      senter =
        _.start === "sliderenter" ||
        (_.frames !== undefined &&
          _.frames[0] != undefined &&
          _.frames[0].delay === "sliderenter")
          ? true
          : false;
        ...
        opt.c.on("tp-mouseenter", function() {
          if (opt.layersonhover)
            jQuery.each(opt.layersonhover, function(i, tnc) {
              var cli =
                  tnc.data("closestli") ||
                  tnc.closest(".tp-revslider-slidesli"),
  ...
  var contWidthManager = function(opt) {
    ...
    if (
      opt.slayers &&
      (opt.sliderLayout != "fullwidth" && opt.sliderLayout != "fullscreen")
    )
    ...
    if (!_R.resizeThumbsTabs || _R.resizeThumbsTabs(opt) === true) {
      ...
      if (nextsh.data("kenburns") == "on")
        _R.startKenBurn(
          nextsh,
          opt,
          nextsh.data("kbtl") !== undefined ? nextsh.data("kbtl").progress() : 0
        );
      ...
      if (actsh.data("kenburns") == "on")
        _R.startKenBurn(
          actsh,
          opt,
          actsh.data("kbtl") !== undefined ? actsh.data("kbtl").progress() : 0
        );

      // DOUBLE CALL FOR SOME FUNCTION TO AVOID PORTRAIT/LANDSCAPE ISSUES, AND TO AVOID FULLSCREEN/NORMAL SWAP ISSUES
      if (_R.animateTheCaptions && c.find(".processing-revslide").length > 0)
        _R.animateTheCaptions({
  ...
  var prepareSlides = function(container, opt) {
    ...
    opt.allli.find(">img").each(function(j) {
      ...
      mediafilter =
        mediafilter === "none" || mediafilter === undefined ? "" : mediafilter;
      img.wrap(
  ...
  var waitForCurrentImages = function(nextli, opt, callback) {
      ...
      if (
        ...
        if (loadobj.type == "img") {
          if (element.hasClass("defaultimg")) {
            if (!_R.isIE(8)) {
              if (
                (loadobj.src.indexOf("images/transparent.png") == -1 &&
                  loadobj.src.indexOf("assets/transparent.png") == -1) ||
                element.data("bgcolor") === undefined
              ) {
    ...
    if (waitforload)
      punchgs.TweenLite.delayedCall(0.18, waitForCurrentImages, [
        nextli,
        opt,
        callback
      ]);
    else punchgs.TweenLite.delayedCall(0.18, callback);
  };
  ...
  var swapSlide = function(container) {
    ...
    if (nextli.index() === -1 && opt.sliderType === "carousel")
      nextli = jQuery(opt.li[0]);
    nextli.data(
  ...
  var countDown = function(container, opt) {
    ...
    container.on("restarttimer", function() {
      ...
      if (
        ...
        bt[0].tween = punchgs.TweenLite.fromTo(
          bt,
          opt.delay / 1000,
          { width: "0%" },
          {
  ...
  var restartOnFocus = function() {
    jQuery(".rev_redraw_on_blurfocus").each(function() {
      ...
      if (opt == undefined || opt.c == undefined || opt.c.length === 0)
        return false;
