...
(function(factory) {
  ...
  function TouchSwipe(element, options) {
    ...
    function touchStart(jqEvent) {
      ...
      if (
        !touches ||
        (fingerCount === options.fingers || options.fingers === ALL_FINGERS) ||
        hasPinches()
      ) {
        ...
        if (missing === 0 && func) {
          ...
          if (global) {
            ...
            if (!hasModule && typeof define === "function" && define.amd) {
              //AMD
              define((window.GreenSockAMDPath
  ...
  _gsScope._gsDefine(
    ...
    function(TweenPlugin, TweenLite) {
      ...
      var _transformProps = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(
        ...
        _getMatrix = function(e, force2D) {
          ...
          if (
            isDefault &&
            _transformProp &&
            ((none = _getComputedStyle(e).display === "none") || !e.parentNode)
          ) {
            if (none) {
          ...
          if (m !== _identity2DMatrix) {
            if (m.length === 16) {
              ...
              if (tm.rotationX || tm.rotationY) {
                ...
                tm.skewX =
                  a12 || a22
                    ? Math.atan2(a12, a22) * _RAD2DEG + tm.rotation
                    : tm.skewX || 0;
        ...
        _setTransformRatio = (_internals.set3DTransformRatio = _internals.setTransformRatio = function(
          v
        ) {
          var t = this.data, //refers to the element's _gsTransform object
            style = this.t.style,
            ...
            if (orig && typeof orig === "string" && _transformProp) {
              ...
              m2.rotation = _parseAngle(
                "rotation" in v
                  ...
                  : "rotationZ" in v
                  ? v.rotationZ
                  : m1.rotation - m1.skewY,
                m1.rotation - m1.skewY,
                "rotation",
                endRotations
              ); //see notes below about skewY for why we subtract it from rotation here
              if (_supports3D) {
      ...
      _registerComplexSpecialProp("border", {
        ...
        parser: function(t, e, p, cssp, pt, plugin) {
          ...
          if (esfx !== "px") {
            ...
            bw =
              parseFloat(bw) / _convertToPixels(t, "borderTopWidth", 1, esfx) +
              esfx;
          }
          return this.parseComplex(
            t.style,
      ...
      p._mod = function(lookup) {
        ...
        while (pt) {
          if (
            typeof lookup[pt.p] === "function" &&
            lookup[pt.p] === Math.round
          ) {
