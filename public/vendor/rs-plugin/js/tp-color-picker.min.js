...
(window.RevColor = {
  ...
  convert: function(e, r) {
    ...
    if (-1 !== e.search(/\[\{/) || -1 !== e.search("gradient"))
      return RevColor.process(e, !0)[0];
    if (void 0 === r || isNaN(r)) return RevColor.process(e, !0)[0];
    if (
      ((r = parseFloat(r)) <= 1 && (r *= 100),
      0 === (r = Math.max(Math.min(parseInt(r, 10), 100), 0)))
    )
      return "transparent";
    try {
      return -1 !== e.search("#") || e.length < 8
        ? (RevColor.isColor.test(e) || (e = e.replace(/[^A-Za-z0-9#]/g, "")),
          RevColor.processRgba(RevColor.sanitizeHex(e), r))
        : ((e = RevColor.rgbValues(e, 3)),
          RevColor.rgbaString(e[0], e[1], e[2], 0.01 * r));
    } catch (e) {
  ...
  process: function(e, r) {
    if ("string" != typeof e)
      return (
        r && (e = RevColor.sanitizeGradient(e)),
        [RevColor.processGradient(e), "gradient", e]
      );
    if ("transparent" === e.trim()) return ["transparent", "transparent"];
    if (-1 === e.search(/\[\{/))
      return -1 !== e.search("#")
        ? [RevColor.sanitizeHex(e), "hex"]
        : -1 !== e.search("rgba")
        ? [e.replace(/\s/g, "").replace(/false/g, "1"), "rgba"]
        : -1 !== e.search("rgb")
        ? [e.replace(/\s/g, ""), "rgb"]
        : RevColor.isColor.test(e)
        ? [e, "hex"]
  ...
  transparentRgba: function(e, r) {
    return (
      !(!r && "rgba" !== RevColor.process(e)[1]) &&
      "0" === RevColor.rgbValues(e, 4)[3]
    );
  },
  rgbValues: function(e, r) {
    3 ===
      (e = e.substring(e.indexOf("(") + 1, e.lastIndexOf(")")).split(","))
        .length &&
      4 === r &&
      (e[3] = "1");
  ...
  getRgbToHex: function(e, r, a) {
    return (
      "#" +
      ("0" + parseInt(e).toString(16)).slice(-2) +
  ...
  processRgba: function(e, r) {
    ...
    return (t += a
      ? ", " + (0.01 * parseInt(r, 10)).toFixed(2).replace(/\.?0*$/, "") + ")"
      : ")");
  },
  processGradient: function(e) {
    for (
      var r,
        a = e.type,
        t = a + "-gradient(",
        i = "linear" === a ? e.angle + "deg, " : "ellipse at center, ",
        o = e.colors,
        c = o.length,
        n = "",
        s = 0;
  ...
  sanitizeGradient: function(e) {
    for (var r, a = e.colors, t = a.length, i = [], o = 0; o < t; o++) {
      ...
      delete c.align,
        r
          ? JSON.stringify(c) !== JSON.stringify(r) && (i[i.length] = c)
          : (i[i.length] = c),
        (r = c);
    }
    return (e.colors = i), e;
  ...
  (function(e) {
    function r(e, r) {
      ...
      return (
        t.shift(),
        (r = void 0 !== r ? r + "deg," : "ellipse at center,"),
        a + "(" + r + t.join(",")
      );
    }
    function a(e) {
    ...
    function n(r) {
      r || (r = {}),
        "string" == typeof r && (r = JSON.parse(r.replace(/\&/g, '"'))),
        (rr = e.extend({}, Or, r)),
        (Te = rr.color),
        ce.find("*[data-placeholder]").each(i),
        ce.find("*[data-alert]").each(o),
        ce.find("*[data-text]").each(t);
    }
    function s(r, a, t, i) {
      var o, c, n;
      if (e.isPlainObject(r)) {
        ...
        for (var p in r)
          r.hasOwnProperty(p) &&
            ("string" == typeof (r = r[p])
              ? ("gradient" === (r = RevColor.process(r))[1] &&
                  ((s = (c = r[2]).angle), (l = c.type)),
                (r = r[0]))
              : ((s = r.angle), (l = r.type)),
            (o = isNaN(p)
              ? p.replace(/_/g, " ").replace(/\b\w/g, function(e) {
      ...
      if ("blank" !== r) {
        e.isPlainObject(r) &&
          ((c = r), "", (r = i || RevColor.processGradient(r)));
        var v =
          ...
          '" data-color="' +
          r +
          '"><span class="rev-cpicker-preset-tile"></span><span class="rev-cpicker-preset-bg" style="background: ' +
          r +
          '"></span>';
        return (
          a ||
      ...
      return (
        ...
        (n.className = "rev-cpicker-color blank"),
        n
      );
    }
    function l() {
    ...
    function p(e, r) {
      for (
        var a = document.createDocumentFragment(),
          t = -1 !== e.search("core"),
          i = t ? "" : " rev-picker-color-custom",
          o = r.length,
          c = -1 !== e.search("colors") ? Ar : Mr,
          n = Math.max(Math.ceil(o / Hr), c),
          l = 0;
        l < n;
        l++
      )
        ...
        if (!e) {
          ...
          r =
            "transparent" === t
              ? "transparent"
              : "100%" === i
              ? RevColor.sanitizeHex(t)
              : RevColor.processRgba(t, i);
        }
        var o = "transparent" === r,
          c = o ? "" : r;
        e ? le.data("state", r) : ue.data("state", r),
          o ? dr.css("background", c) : (dr[0].style.background = c),
          te && te(or, r),
          X.trigger("revcolorpickerupdate", [or, r]);
      }
    }
    function d(e, r) {
      ...
      if ((K && se.removeClass("checked"), "gradient" !== t)) {
        ...
        K
          ? (I(a[2]), N(), r || ((We = !0), le.click()))
          : (Ve.val(RevColor.defaultValue).change(), ue.click());
      return [i, t];
    }
    function g(e, r) {
      var a,
        t = ee.slice(),
        i = t.length;
      for (t.sort(T); i--; ) if ((a = t[i]).align === e && a.x < r) return a;
      i = t.length;
      for (var o = 0; o < i; o++)
    ...
    function b(r, a) {
      var t = g(r, a).color,
        i = u(t, r, !0),
        o = h(r, a, f(t, !0), i);
      xe && xe.removeClass("active"),
        (xe = e(o)
          .addClass("active")
          .appendTo(Ze)
          .draggable(Er)),
        (He = xe.children(".rev-cpicker-point-square")[0]),
        (Se = xe.children(".rev-cpicker-point-triangle")[0]),
        (Ue = Ze.children());
      var c = k(a);
    ...
    function k(e) {
      ...
      if (a)
        hr.hasClass("active") &&
          ...
          (r = RevColor.rgbaToHex(r)[0]),
          ke.css("background", r),
          me.removeAttr("disabled").val(e + "%"),
          ce.find(".rev-cpicker-point-bottom").length > 2 &&
            er.addClass("active"),
          ce.addClass("open");
      else {
        er.hasClass("active") &&
        ...
        Qe.attr("data-opacity", t)
          .val(t)
          .removeAttr("disabled"),
          Ye.val(e + "%").removeAttr("disabled"),
          ce.find(".rev-cpicker-point-top").length > 2 && hr.addClass("active"),
          ce.removeClass("open");
      }
      return [a, r];
    }
    ...
    function m(e) {
      for (
        var r, a, t = document.createDocumentFragment(), i = e.length, o = 0;
        o < i;
        o++
      )
        (r = (a = e[o]).align), t.appendChild(h(r, a.position, f(a), u(a, r)));
      Ue && Ue.draggable("destroy"),
        Ze.empty().append(t),
        (Ue = Ze.children().draggable(Er));
    }
    function h(r, a, t, i) {
      var o = document.createElement("span");
      return (
        (o.className = "rev-cpicker-point rev-cpicker-point-" + r),
        "string" == typeof t
          ? o.setAttribute("data-color", t)
          : e(o).data("gradient", t),
        o.setAttribute("data-location", a),
        (o.style.left = a + "%"),
        (o.innerHTML =
          "bottom" === r
            ? '<span class="rev-cpicker-point-triangle" style="border-bottom-color: ' +
              i +
              '"></span><span class="rev-cpicker-point-square" style="background: ' +
              i +
              '"></span>'
            : '<span class="rev-cpicker-point-square" style="background: ' +
              i +
              '"></span><span class="rev-cpicker-point-triangle" style="border-top-color: ' +
              i +
              '"></span>'),
        o
      );
    ...
    function y(e, r) {
      ce.removeClass("active is-basic").hide(),
        Z.removeClass("rev-colorpicker-open"),
        mr.css({ left: "", top: "" }),
        ye && (ye.remove(), (ye = !1)),
        Cr
          ? (Cr.hasClass("selected")
              ? (r && or.data("hex", Cr.attr("data-color").toLowerCase()),
        ...
        r ||
          (Re && Re(),
          lr && "transparent" !== lr
            ? (dr[0].style.background = lr)
            : dr.css("background", ""),
          X.trigger("revcolorpickerupdate", [or, lr])),
        (dr = !1),
        (or = !1);
    }
    function w() {
      ...
      return (
        r > Hr
          ? e("#" + this.id + "-btn").addClass("multiplerows")
          : e("#" + this.id + "-btn").removeClass("multiplerows"),
        r
      );
    }
    function R() {
    ...
    function I(r) {
      var a = r.angle;
      "radial" === r.type && (a = "radial"),
        $e.removeClass("selected"),
        e('.rev-cpicker-orientation[data-direction="' + a + '"]').addClass(
          "selected"
        ),
        Q.val(C(a)),
        O(a),
    ...
    function N(e, r, t) {
      (Oe = r), V(), (Oe = !1);
      for (var i, o, c, n = [], s = ee.length, l = 0; l < s; l++)
        (o = (c = ee[l]).color),
          (n[l] = o),
          (i = c.el).setAttribute(
            "data-color",
            RevColor.rgbaString(o.r, o.g, o.b, o.a)
          ),
          i.setAttribute("data-opacity", 100 * o.a),
          e && e === i && (Je = l);
      re.hasClass("selected")
        ? ((Ir.type = "radial"), (Ir.angle = "0"))
        : ((Ir.type = "linear"), (Ir.angle = parseInt(Q.val(), 10).toString())),
        (Ir.colors = n),
        Cr && Cr.removeClass("selected");
    ...
    function F(e, r) {
      if (0 === e) return !1;
      for (var a; e--; ) if ((a = ee[e]).align !== r) return a;
      return !1;
    }
    function j(e, r, a) {
      if (e === a) return !1;
      for (var t; e++ < a; ) if ((t = ee[e]).align !== r) return t;
      return !1;
    }
    function M(e, r, a, t, i) {
      return Math.max(
        Math.min(Math.round(Math.abs(((e - r) / (a - r)) * (i - t) + t)), 255),
        0
      );
    }
    function A(e, r, a, t, i) {
      return Math.max(
        Math.min(
          Math.abs(
            parseFloat((((e - r) / (a - r)) * (i - t)).toFixed(2)) +
              parseFloat(t)
          ),
          1
        ),
    ...
    function H(e, r, a) {
      var t,
        i = r.alpha,
        o = a.alpha;
      (t = i !== o ? A(e.x, r.x, a.x, i, o).toFixed(2) : i),
        (e.alpha = t),
        (e.color.a = t);
    }
    function S(e, r, a) {
    ...
    function V() {
      ...
      for (var e, r, a, t, i = ee.length, o = i - 1, c = 0; c < i; c++)
        !1 === (r = F(c, (a = (e = ee[c]).align))) && (r = j(c, a, o)),
          !1 === (t = j(c, a, o)) && (t = F(c, a)),
          "bottom" === a ? H(e, r, t) : S(e, r, t);
      ee.sort(T);
    }
    function T(e, r) {
    ...
    function E(e) {
      ...
      Oe &&
        (i < 50 ? (i += 2 * (50 - i)) : (i -= 2 * (i - 50)),
        (this.style.left = i + "%"),
        this.setAttribute("data-location", i)),
        (ee[e] = {
          el: this,
          x: i,
          alpha: t,
        ...
        xe &&
          xe[0] !== this &&
          ("bottom" === a ? (je[je.length] = i) : (Fe[Fe.length] = i));
    }
    function O(e) {
      (e = void 0 !== e ? e : parseInt(Q.val(), 10)),
        (Be[0].style.transform = "rotate(" + e + "deg)");
    }
    function P(r, a, t) {
      var i,
        o,
      ...
      if (r && "keyup" === r.type)
        (i = !isNaN(n) && n >= -360 && n <= 360), (o = n);
      else {
        var s = parseInt(Q.data("orig-value"), 10);
        n || (n = "0"),
          (isNaN(n) || n < -360 || n > 360) && (n = s),
          n !== s &&
            ((o = n),
            (i = !0),
            Q.val(C(n)),
            c ||
              ...
              $e.removeClass("selected"),
              e(
                '.rev-cpicker-orientation[data-direction="' + n + '"]'
              ).addClass("selected")));
      }
      (i || a) && (o && O(o), N());
    }
    function z() {
      var r = e(this);
      -1 !== this.className.search("down")
        ? (r.parent().addClass("active"),
          r.closest(".rev-cpicker-presets").addClass("active"),
          e(this.id.replace("-btn", "")).addClass("active"),
          (ur = ce.hasClass("gradient-view")))
        : (r.parent().removeClass("active"),
          r.closest(".rev-cpicker-presets").removeClass("active"),
          e(this.id.replace("-btn", "")).removeClass("active"),
          (ur = !1));
    }
    function D(e, r) {
      var a = parseInt(
        100 * (Math.round(r.position.left) / (Nr - 2)).toFixed(2),
        10
      );
      "bottom" === Ne
        ? me.val(a + "%").trigger("keyup")
        : Ye.val(a + "%").trigger("keyup");
    }
    function L() {
      var r = e(this);
      (Ne = r.hasClass("rev-cpicker-point-bottom") ? "bottom" : "top"),
        r.click();
    }
    function B() {
    ...
    function G(e) {
      (yr = !0), xr.slider("value", Math.round(0.01 * e * Tr)), (yr = !1);
    }
    function q(e) {
      var r = Le.offset(),
        a = e.pageX - r.left,
      ...
      if (!isNaN(a) && !isNaN(t)) {
        ...
        i < 0 && (i += 360),
          (i = Math.max(0, Math.min(360, Math.round(i)))),
          (i = 5 * Math.round(i / 5)),
          (br = !0),
          P(!1, !1, i),
          (br = !1);
    ...
    function J() {
      ne || e.tpColorPicker(),
        (wr = document.getElementById("rev-cpicker-current-edit")),
        (Ge = document.getElementById("rev-cpicker-gradient-output")),
        (Ee = document.getElementById("rev-cpicker-gradient-input")),
        (ze = document.getElementById("rev-cpicker-edit-title")),
        (Ae = document.createElement("textarea")),
        (hr = e("#rev-cpicker-opacity-delete")),
        (Ze = e("#rev-cpciker-point-container")),
        (Ye = e("#rev-cpicker-opacity-location")),
        (cr = e(".rev-cpicker-presets-group")),
        (sr = e("#rev-cpicker-color-opacity")),
        (re = e("#rev-cpicker-orientation-radial")),
        (er = e("#rev-cpicker-color-delete")),
        (Qe = e("#rev-cpicker-grad-opacity")),
        (me = e("#rev-cpicker-color-location")),
        (we = e("#rev-cpicker-gradients-core")),
        ($e = e(".rev-cpicker-orientation")),
        (he = e("#rev-cpicker-iris-gradient")),
        (Be = e("#rev-cpicker-wheel-point")),
        (Ke = e("#rev-cpicker-gradients")),
        (Ve = e("#rev-cpicker-iris-color")),
        (le = e("#rev-cpicker-gradient-btn")),
        (pe = e("#rev-cpicker-gradient-hex")),
        (qe = e("#rev-cpciker-clear-hex")),
        (se = e("#rev-cpicker-meta-reverse")),
        (Me = e("#rev-cpicker-hit-bottom")),
        (xr = e("#rev-cpicker-scroll")),
        (nr = e("#rev-cpicker-colors")),
        (fe = e("#rev-cpicker-color-hex")),
        (ue = e("#rev-cpicker-color-btn")),
        (ke = e("#rev-cpicker-color-box")),
        (Q = e("#rev-cpicker-meta-angle")),
        (Le = e("#rev-cpicker-wheel")),
        (ae = e("#rev-cpicker-hit-top")),
        (mr = e("#rev-cpicker")),
        (X = e(document)),
        (Er.drag = D),
        (Er.stop = B),
        ...
        cr.perfectScrollbar({ wheelPropagation: !1, suppressScrollX: !0 }),
        ...
        e(".rev-cpicker-main-btn").on("click.revcpicker", function() {
          var r;
          if (
            ((De = -1 === this.id.search("gradient")),
            dr && (r = e(this).data("state")),
            De
              ? (dr && (ir = fe.val()),
                ce.removeClass("gradient-view").addClass("color-view"))
              : (dr && (ir = r),
                ce.removeClass("color-view").addClass("gradient-view"),
                We ||
                  we
                    .children(".rev-cpicker-color")
                    .not(".blank")
                    .eq(0)
                    .click()),
            cr.perfectScrollbar("update"),
            r)
          ) {
            var a = "transparent" === r,
              t = a ? "" : r;
            a ? dr.css("background", t) : (dr[0].style.background = t),
              (kr = !0),
              e(".rev-cpicker-color")
                .not(".blank")
                .each(l),
        ...
        e("#rev-cpicker-check").on("click.revcipicker", function() {
          ...
          if (ce.hasClass("color-view")) {
            var i = fe.val(),
              o = sr.val();
            or.removeData("gradient"),
              (a =
                "transparent" === i
                  ? "transparent"
                  : "100%" === o
                  ? RevColor.sanitizeHex(i)
                  : RevColor.processRgba(i, o)),
              (r = [or, a, !1]);
          } else {
            x();
            var c = N(!1, !1, !0),
        ...
        ce.on("click.revcpicker", function(r) {
          if (ce.hasClass("open")) {
            var a = r.target,
              ...
              i = a.id,
              o =
                -1 !== a.className.search("rev-cpicker-point") ||
                "rev-cpicker-section-right" === i ||
                -1 !== i.search("hit") ||
                t.closest("#rev-cpicker-section-right, #rev-cpicker-point-wrap")
                  .length;
            o &&
              ("text" === t.attr("type")
                ? (o = !t.attr("disabled"))
                : "rev-cpicker-check-gradient" === i && (o = !1)),
              o || x();
        ...
        e(".rev-cpicker-close").on("click.revcpicker", y),
        Ve.wpColorPicker({
          palettes: !1,
          width: 267,
          border: !1,
          ...
          change: function(e, r) {
            ...
            if (((this.value = a), fe.val(a), !gr)) {
              var t = sr.val();
              0 === parseInt(t, 10) && (a = "transparent"),
                v(!1, a, t),
                Cr && (Cr.removeClass("selected"), (Cr = !1));
            }
          }
        }),
        he.wpColorPicker({
          ...
          change: function(e, r) {
            ...
            (this.value = a),
              pe.val(a),
              ke.css("background", a),
              (He.style.backgroundColor = a),
              (Se.style.borderBottomColor = a);
        ...
        xr.slider({
          ...
          slide: function(e, r) {
            if (!yr) {
              var a,
                t = parseInt(100 * (r.value / Tr).toFixed(2), 10);
              fr && ((a = t ? "#ffffff" : "transparent"), fe.val(a)),
                0 === t && (a = "transparent"),
                v(!1, a, t || "transparent"),
                sr.val(t + "%");
            }
        ...
        e(".rev-cpicker-point-location")
          .on("keyup.revcpicker focusout.revcpicker", function(e) {
            if (xe) {
              ...
              for (
                isNaN(o) &&
                  (o = "keyup" === c ? "0" : xe.attr("data-location")),
                  r =
                    (o = Math.max(0, Math.min(100, parseInt(o, 10)))) < 50
                      ? 1
                      : -1;
                -1 !== t.indexOf(o);
                ...
                o += r;
              "focusout" === c && (i.val(o + "%"), xe.attr("data-location", o)),
                xe.css("left", o + "%"),
                N();
            }
          })
          .on("focusin.revcpicker", $),
        e("body")
          .on("click.revcpicker", ".rev-cpicker-point", function() {
            Ze.find(".rev-cpicker-point.active").removeClass("active"),
              (xe = e(this).addClass("active")),
              (He = xe.children(".rev-cpicker-point-square")[0]),
              (Se = xe.children(".rev-cpicker-point-triangle")[0]),
              N(this),
              (Cr = !1);
          ...
          .on("mousemove.revcpicker", function(e) {
            if (xe && xe.data("mousestart")) {
              var r = xe.data("mousestart"),
                a = e.pageY;
              xe.hasClass("rev-cpicker-point-bottom")
                ? a > r && a - r > Vr && er.hasClass("active")
                  ? xe.addClass("warning")
                  : xe.removeClass("warning")
                : r > a && r - a > Vr && hr.hasClass("active")
                ? xe.addClass("warning")
                : xe.removeClass("warning");
            }
          })
          .on("mouseup.revcpicker", function(e) {
            if (xe && xe.data("mousestart")) {
              var r = xe.data("mousestart"),
                a = e.pageY;
              xe.removeData("mousestart"),
                xe.hasClass("rev-cpicker-point-bottom")
                  ? a > r && a - r > Sr && er.hasClass("active")
                    ? er.click()
                    : xe.removeClass("warning")
                  : r > a && r - a > Sr && hr.hasClass("active")
                  ? hr.click()
                  : xe.removeClass("warning");
            }
          })
          .on("change.revcpicker", ".rev-cpicker-component", function() {
            ...
            ("transparent" === a || RevColor.transparentRgba(a)) && (a = ""),
              r.data("tpcp").css("background", a);
          })
          ...
          .on("click.revcpicker", ".rev-cpicker-color:not(.blank)", function() {
            ...
            if (
              (i.hasClass("active") && i.find(".rev-cpicker-arrow-up").click(),
              ce.hasClass("color-view"))
            ) {
              var o = Cr.attr("data-color");
              (gr = !0),
                Ve.val(o).change(),
                "transparent" === fe.val() && fe.val(o.toLowerCase()),
                (gr = !1);
              var c = sr.val();
            ...
            if (oe) {
              if (
                ...
                var r = e(this),
                  ...
                  t = a.attr("data-title") || "";
                if (!t)
                  return void console.log("Preset does not have a name/title");
                var i = r.closest(".rev-cpicker-presets-group")[0].id,
                  o = -1 !== i.search("colors") ? "colors" : "gradients";
                X.off("revcpicker_onajax_delete.revcpicker").on(
                  "revcpicker_onajax_delete.revcpicker",
                  function(t, o) {
                    o && console.log(o);
                    ...
                    a.remove(),
                      R.call(c[0])
                        ...
                        : e(
                            '<span class="rev-cpicker-color blank"></span>'
                          ).insertBefore(n),
                      w.call(c[0]) < Hr + 1 &&
                        (e(
                          '<span class="rev-cpicker-color blank"></span>'
                        ...
                        s.hasClass("active") &&
                          s.children(".rev-cpicker-arrow-up").click()),
                      ce.removeClass("onajax onajaxdelete");
                  }
                ),
                  (t = e
                    .trim(t.replace(/\W+/g, "_"))
                    .replace(/^\_|\_$/g, "")
                    .toLowerCase()),
                  oe("delete", t, o, "revcpicker_onajax_delete", or);
              }
              return !1;
            }
        ...
        e(".rev-cpicker-save-preset-btn").on("click.revcpicker", function() {
          if (oe) {
            ...
            if (i && isNaN(i)) {
              if (
                ((r = ce.hasClass("color-view") ? "colors" : "gradients"),
                (i = e
                  .trim(i.replace(/\W+/g, "_"))
                  .replace(/^\_|\_$/g, "")
                  .toLowerCase()),
                e("#rev-cpicker-" + r + "-custom")
                  .find(".rev-cpicker-color")
                  .not(".blank")
                  .each(function() {
                    if (
                      e
                        .trim(c(this, "data-title").replace(/\W+/g, "_"))
                        .replace(/^\_|\_$/g, "")
                        .toLowerCase() === i
                    )
                      return alert(t.attr("data-message")), (a = !0), !1;
                  }),
                !a)
              ) {
                ...
                if ("colors" === r) {
                  ...
                  o =
                    "transparent" === p
                      ? "transparent"
                      : "100%" === v
                      ? RevColor.sanitizeHex(p)
                      : RevColor.processRgba(p, v);
                } else
                  (n = Ge.style.background),
                    (o = e.extend({}, N(!1, !1, !0)[0]));
                (l[i] = o),
                  X.off("revcpicker_onajax_save.revcpicker").on(
                    "revcpicker_onajax_save.revcpicker",
                    function(a, i) {
                      if (i)
                        return (
                          ce.removeClass("onajax onajaxsave"),
                          void alert(t.attr("data-message"))
                        );
                      var o = e(s(l, !1, " rev-picker-color-custom", n)),
                        ...
                        v = e("#" + c[0].id + "-btn");
                      p.length
                        ? o.insertBefore(p.eq(0))
                        : o.insertBefore(c.find(".ps-scrollbar-x-rail")),
                        e("#rev-cpicker-" + r + "-custom-btn").click(),
                        w.call(c[0]) > 6 &&
                          (p.length && p.last().remove(),
                          v
                            .addClass("active")
        ...
        e(".rev-cpicker-preset-title").on("click.revcpicker", function() {
          ...
          z.call(r.find(".rev-cpicker-arrow-" + t)[0]),
            a.find(".rev-cpicker-preset-title").removeClass("selected"),
            r.addClass("selected"),
            a.find(".rev-cpicker-presets-group").hide(),
        ...
        qe.on("click.revcpicker", function() {
          sr.val("0%"),
            G(0),
            Ve.val(RevColor.defaultValue).change(),
            fe.val("transparent"),
            v(!1, "transparent");
        }),
        ce
        ...
        e(".rev-cpicker-hex")
          .on("focusout.revcpicker", function() {
            ...
            if ("rev-cpicker-color-hex" === this.id) {
              if ((t = fe.val()))
                if (((t = RevColor.sanitizeHex(t)), RevColor.isColor.test(t)))
                  fe.val(t);
                else {
                  if (((r = e(this)), !(a = r.data("orig-value"))))
                    return void qe.click();
                  (t = a), fe.val(t);
                }
              else t = "transparent";
              Ve.val(t).change();
          ...
          .on("focusin.revcpicker", $),
        e("#rev-cpciker-clear-gradient").on("click.revcpicker", function() {
          he.val(RevColor.defaultValue).change();
        }),
        Q.on("keyup.revcpicker focusout.revcpicker", P)
          .on("focusin.revcpicker", function() {
            (Xe = !0), Le.addClass("active");
          })
          .on("focusin.revcpicker", $),
        $e.on("click.revcpicker", function() {
          var r = e(this),
            a = r.attr("data-direction");
          $e.removeClass("selected"),
            r.addClass("selected"),
            "radial" !== a
              ? Q.removeAttr("disabled").val(C(a))
        ...
        e(".rev-cpicker-preset-save").on("focusin.revcpicker", $),
        e(".rev-cpicker-opacity-input")
          .on("keyup.revcpicker focusout.revcpicker", function(r) {
            var a,
            ...
            if (
              (isNaN(o) &&
                (o = "keyup" === c ? "0" : e(this).data("orig-value")),
              (o = Math.max(0, Math.min(100, o))),
              "focusout" === c &&
                (i.val(o + "%"), t || xe.attr("data-opacity", o)),
              t)
            )
              v(!1, 0 === parseInt(o, 10) && "transparent", o), G(o);
            else {
              var n = RevColor.rgbValues(xe.attr("data-color"), 3),
                s = Ir.colors[Je];
              (o = (0.01 * parseInt(o, 10)).toFixed(2).replace(/\.?0*$/, "")),
                (s.r = n[0]),
                (s.g = n[1]),
                (s.b = n[2]),
                (s.a = o),
                (a = RevColor.rgbaString(s.r, s.g, s.b, o)),
                xe.attr("data-color", a),
                N(),
                (a = "rgba(0, 0, 0, " + o + ")"),
                (He.style.backgroundColor = a),
                (Se.style.borderTopColor = a);
            }
          })
          .on("focusin.revcpicker", $),
        e(".rev-cpicker-builder-hit").on("click.revcpicker", function(e) {
          ee || V();
          for (
            var r = parseInt(
                100 * ((e.pageX - ae.offset().left) / Nr).toFixed(2),
                10
              ),
              a = -1 !== this.id.search("bottom") ? "bottom" : "top",
              t = "bottom" === a ? je : Fe,
              i = r < 50 ? 1 : -1;
            -1 !== t.indexOf(r);
            ...
            r += i;
          "bottom" === a
            ? ce.find(".rev-cpicker-point-bottom").length < Fr
              ? (b(a, r), (Cr = !1))
              : Me.addClass("full")
            : ce.find(".rev-cpicker-point-top").length < Fr
            ? (b(a, r), (Cr = !1))
            : ae.addClass("full");
        }),
        se.on("click.revcpicker", function() {
          !se.hasClass("checked")
            ? se.addClass("checked")
            : se.removeClass("checked"),
            N(!1, !0);
        }),
        e(".rev-cpicker-arrow").on("click.revcpicker", z),
        (U = !0);
    }
    function Y(r) {
      var a,
        ...
        l = n.custom;
      !ar || l
        ? ((o = 4), (l = (ar = l) || { colors: [], gradients: [] }))
        : (o = 2),
        s.colors || (s.colors = Pr),
        s.gradients || (s.gradients = zr);
      for (var v = 0; v < o; v++) {
        switch (v) {
          case 0:
        ...
        (t = p(a, i.slice() || [])),
          (c = e("#" + t[0])).find(".rev-cpicker-color").remove(),
          c.prepend(t[1]);
      }
    }
    function W(e) {
    ...
    var Dr = {
      refresh: function() {
        ...
        if (r.hasClass("rev-cpicker-component")) {
          ...
          (t = i[0]),
            (i = "rgba" === i[1] && RevColor.transparentRgba(t, !0) ? "" : t),
            "transparent" !== t
              ? (r.data("tpcp")[0].style.background = i)
              : r.data("tpcp").css("background", ""),
            r.attr("data-color", t).data("hex", t);
        }
      },
      destroy: function() {
        e(this)
    ...
    (e.fn.tpColorPicker = function(r) {
      return r && "string" == typeof r
        ...
        : this.each(function() {
            ...
            if (a.hasClass("rev-cpicker-component")) a.tpColorPicker("refresh");
              ...
              var t,
                i,
                o = e('<span class="rev-colorpicker"></span>').data(
                  "revcolorinput",
                  a
                ),
              ...
              s || (s = Rr),
                s && o.addClass(s),
                p && o.attr("id", p),
                g || ((g = i || RevColor.defaultValue), a.val(g)),
                (g = (t = RevColor.process(g))[0]),
                3 === t.length && a.val(g),
                "transparent" !==
                  (t =
                    "rgba" === t[1] && RevColor.transparentRgba(g, !0)
                      ? ""
                      : g) && (c[0].style.background = t),
                (n[0].innerHTML = v || Te || Or.color),
                a
                  .attr({ type: "hidden", "data-color": g })
                  .data("tpcp", c)
                  .addClass("rev-cpicker-component"),
                d && o.addClass(d),
                l
                  ? ((l = e(l).addClass("rev-cpicker-master-wrap")), o.wrap(l))
                  : o.addClass("rev-cpicker-master-wrap");
              var u = !!r && (r.init || ie);
              u && u(o, a, g, r);
            }
          });
      ...
      e(function() {
        e("body").on("click.revcpicker", ".rev-colorpicker", function() {
          ...
          if (
            (C &&
              ((C = JSON.parse(C.replace(/\&/g, '"'))).colors && (c = C.colors),
              C.gradients && (i = C.gradients)),
            y)
          ) {
            var _ = y.colors;
            _ &&
              (_.core && ((t = _.core.colors), (r = _.core.gradients)),
              _.custom && ((o = _.custom.colors), (a = _.custom.gradients))),
              (b = y.onEdit),
              (k = y.onAjax),
              (p = y.change),
              (v = y.cancel),
          ...
          (r || t || a || o || i || c) &&
            ((s = {}),
            (r || t || i || c) &&
              (s.core = { colors: c || t || Pr, gradients: i || r || zr }),
            (a || o) && (s.custom = { colors: o || Pr, gradients: a || zr }),
            Y(s)),
            f || (f = tr),
            f && (ce[0].id = f),
            m || (m = vr),
            m && (ye = e(m).appendTo(mr)),
            R && n(R),
            x || (x = ve),
            h
              ? (ze.style.visibility = "visible")
              : ((h = ""), (ze.style.visibility = "hidden")),
            (wr.innerHTML = h),
            "single" === x || "basic" === x
              ? ((K = !1),
                le.hide(),
                ue.show(),
                "basic" === x && ce.addClass("is-basic"))
              : ((K = !0), le.show(), ue.show()),
            (u =
              or.val() || or.attr("data-color") || RevColor.defaultValue).split(
              "||"
            ).length > 1 && ((u = RevColor.joinToRgba(u)), or.val(u)),
            (g = d(u)),
            (lr = g[0]),
            (te = b || ge),
            (oe = k || be),
            (Re = v || _e),
            (_r = p || Ie),
            "gradient" !== g[1] ? ue.data("state", lr) : le.data("state", lr),
            Z.addClass("rev-colorpicker-open"),
            (dr = or.data("tpcp")),
            ce
              .data("revcpickerinput", or)
              .addClass("active")
              .show(),
            cr.each(w).perfectScrollbar("update"),
            (pr = or.attr("data-color")),
            (ir = or.data("hex")),
            e(".rev-cpicker-color")
              .not(".blank")
              .each(l);
