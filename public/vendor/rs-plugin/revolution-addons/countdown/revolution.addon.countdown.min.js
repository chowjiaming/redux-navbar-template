...
function tp_countdown(api, targetdate, slidechanges) {
  ...
  function countprocess(event) {
    ...
    if (newd != currentd)
      currentd = animateAndUpdate(jQuery("#t_days"), newd, currentd);
    if (newh != currenth)
      currenth = animateAndUpdate(jQuery("#t_hours"), newh, currenth);
    if (newm != currentm)
      currentm = animateAndUpdate(jQuery("#t_minutes"), newm, currentm);
    if (news != currents)
      currents = animateAndUpdate(jQuery("#t_seconds"), news, currents);
