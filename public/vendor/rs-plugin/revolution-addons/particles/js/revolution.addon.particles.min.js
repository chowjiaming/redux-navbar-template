...
(function() {
  ...
  window.RsParticlesAddOn = function(f) {
    function k(a, b) {
      ...
      c >= p && c <= n
        ? ((u = "." + r + "-tp-particles-" + c),
          v
            ? w || pJSDomRs[x].pJS.fn.vendors.draw()
            : ((v = !0), (x = pJSDomRs.length), particlesJSRs(u, l, r, q, f)),
          (y = setTimeout(m, 100)),
          (w = !0))
        : v &&
          (rspCancelAnimFrame(pJSDomRs[x].pJS.fn.drawAnimFrame),
    ...
    if (f) {
      ...
      if (b.enable || (d.enable && "grab" === d.mode))
        for (b = b.color = b.color.split(","), d = b.length; d--; )
          b[d] = t(b[d]);
      "image" === c.type &&
        ((c = c.image),
        (c.src =
          '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="{{viewbox}}"><path fill="#ffffff" stroke="{{stroke-color}}" stroke-width="{{stroke-width}}" d="' +
          c.src +
          '"></path></svg>'),
        a
          ? ((b = 2 * a + 24),
            (c.src = c.src
              .replace("{{stroke-width}}", a)
              .replace("{{viewbox}}", -a + " " + -a + " " + b + " " + b)))
          : (c.src = c.src
              .replace("{{viewbox}}", "0 0 24 24")
              .replace("{{stroke-width}}", 0)));
      f.one("revolution.slide.onloaded", function() {
        var a,
          b = l.zIndex,
          c = r + "-tp-particles-",
        ...
        f.find(".tp-revslider-slidesli").each(function(e) {
          if (d) {
            var h = jQuery(this);
            h.find(".slidelink").length
              ? ((a = !0),
                "back" !== h.data("slideindex") && (b = 999),
                (this.className += " rs-particles-slidelink"))
              : (this.className += " rs-particles-interactive");
          }
    ...
    if (pJSDomRs)
      if (f) {
        var k = f[0].id,
          g = pJSDomRs.length;
        f.off(
          "revolution.slide.onbeforeswap revolution.slide.onloaded .rsparticles"
        );
        for (f = 0; f < g; f++)
  ...
  var C = function(f, k, g, m, l) {
    function p(b, c, d, h, f, g, e, k) {
      h != f &&
        (a.tmp.bubble_duration_end
          ? void 0 != g &&
            ((c =
              h +
              (h -
                (e - (d * (e - h)) / a.interactivity.modes.bubble.duration))),
            "size" == k && (b.radius_bubble = c),
            "opacity" == k && (b.opacity_bubble = c))
          : c <= a.interactivity.modes.bubble.distance
          ? (void 0 != g ? g : e) != h &&
            ((c = e - (d * (e - h)) / a.interactivity.modes.bubble.duration),
            "size" == k && (b.radius_bubble = c),
            "opacity" == k && (b.opacity_bubble = c))
          : ("size" == k && (b.radius_bubble = void 0),
            "opacity" == k && (b.opacity_bubble = void 0)));
    }
    function n() {
    ...
    this.tpId = m;
    var a = (this.pJS = {
      canvas: { el: f, w: f.offsetWidth, h: f.offsetHeight },
      particles: {
    ...
    a.fn.retinaInit = function() {
      a.retina_detect && 1 < window.devicePixelRatio
    ...
    a.fn.particle = function(b, c, d) {
      ...
      a.particles.size.anim.enable &&
        ...
        a.particles.size.anim.sync || (this.vs *= Math.random()));
      ...
      a.particles.move.random &&
        ((d = Math.round(Math.random() * (d - c) + c)), 1 > d && (d = 1));
      this.spd = d;
      this.color = {};
      "object" == typeof b.value
        ...
        : "string" == typeof b.value &&
          ((this.color = b), (this.color.rgb = t(this.color.value)));
      b = a.particles.shape.stroke.color;
      this.strokeColor = b[Math.floor(Math.random() * b.length)];
      ...
      a.particles.opacity.anim.enable &&
        ...
        a.particles.opacity.anim.sync || (this.vo *= Math.random()));
      ...
      a.particles.move.straight
        ? ((this.vx = b), (this.vy = d))
        : ((this.vx = b + Math.random() - 0.5),
          (this.vy = d + Math.random() - 0.5));
      this.vx_i = this.vx;
      this.vy_i = this.vy;
      b = a.particles.shape.type;
      "object" == typeof b
        ? b instanceof Array &&
          (this.shape = b[Math.floor(Math.random() * b.length)])
        : (this.shape = b);
      "image" == this.shape &&
        ((b = a.particles.shape),
        (this.img = {
    ...
    a.fn.particle.prototype.draw = function() {
      ...
      a.canvas.ctx.fillStyle = this.color.rgb
        ? "rgba(" +
          this.color.rgb.r +
          "," +
          this.color.rgb.g +
      ...
      switch (this.shape) {
        ...
        case "polygon":
          a.fn.vendors.drawShape(
            a.canvas.ctx,
            this.x - c / (a.particles.shape.polygon.nb_sides / 3.5),
            this.y - c / 0.76,
            (2.66 * c) / (a.particles.shape.polygon.nb_sides / 3),
        ...
        case "star":
          a.fn.vendors.drawShape(
            a.canvas.ctx,
            this.x - (2 * c) / (a.particles.shape.polygon.nb_sides / 4),
            this.y - c / 1.52,
            (5.32 * c) / (a.particles.shape.polygon.nb_sides / 3),
            a.particles.shape.polygon.nb_sides,
            2
          );
          break;
        case "image":
          (a.canvas.ctx.globalAlpha = d),
            (b = "svg" == a.tmp.img_type ? this.img.obj : a.tmp.img_obj) &&
              this.drawSVG(b, c),
            (a.canvas.ctx.globalAlpha = 1),
            (b = !0);
      }
      a.canvas.ctx.closePath();
      b ||
        (0 < a.particles.shape.stroke.width &&
          ((a.canvas.ctx.strokeStyle = this.strokeColor),
    ...
    a.fn.particlesCreate = function() {
      for (
        var b = a.particles.number.value, c = a.particles.array, d = 0;
        d < b;
        d++
      )
        c[c.length] = new a.fn.particle(
          a.particles.color,
    ...
    a.fn.particlesUpdate = function() {
      for (var b, c, d, h, f = a.particles.array.length, g = 0; g < f; g++) {
        ...
        a.particles.move.enable &&
          ((b = e.spd / 2), (e.x += e.vx * b), (e.y += e.vy * b));
        a.particles.opacity.anim.enable &&
          (1 == e.opacity_status
            ? (e.opacity >= e.opc && (e.opacity_status = !1),
              (e.opacity += e.vo))
            : (e.opacity <= a.particles.opacity.anim.opacity_min &&
                (e.opacity_status = !0),
              (e.opacity -= e.vo)),
          0 > e.opacity && (e.opacity = 0));
        a.particles.size.anim.enable &&
          (1 == e.size_status
            ? (e.radius >= a.particles.size.value && (e.size_status = !1),
              (e.radius += e.vs))
            : (e.radius <= a.particles.size.anim.size_min &&
                (e.size_status = !0),
              (e.radius -= e.vs)),
          0 > e.radius && (e.radius = 0));
        "bounce" == a.particles.move.out_mode
          ? ((b = e.radius), (c = a.canvas.w), (d = e.radius), (h = a.canvas.h))
          : ((b = -e.radius),
            (c = a.canvas.w + e.radius),
            (d = -e.radius),
            (h = a.canvas.h + e.radius));
        e.x - e.radius > a.canvas.w
          ? ((e.x = b), (e.y = Math.random() * a.canvas.h))
          : 0 > e.x + e.radius &&
            ((e.x = c), (e.y = Math.random() * a.canvas.h));
        e.y - e.radius > a.canvas.h
          ? ((e.y = d), (e.x = Math.random() * a.canvas.w))
          : 0 > e.y + e.radius &&
            ((e.y = h), (e.x = Math.random() * a.canvas.w));
        switch (a.particles.move.out_mode) {
          case "bounce":
            e.x + e.radius > a.canvas.w
              ? (e.vx = -e.vx)
              : 0 > e.x - e.radius && (e.vx = -e.vx),
              e.y + e.radius > a.canvas.h
                ? (e.vy = -e.vy)
                : 0 > e.y - e.radius && (e.vy = -e.vy);
        }
        -1 < a.interactivity.events.onhover.mode.indexOf("grab") &&
          a.fn.modes.grabParticle(e);
        (-1 < a.interactivity.events.onhover.mode.indexOf("bubble") ||
          -1 < a.interactivity.events.onclick.mode.indexOf("bubble")) &&
          a.fn.modes.bubbleParticle(e);
        (-1 < a.interactivity.events.onhover.mode.indexOf("repulse") ||
          -1 < a.interactivity.events.onclick.mode.indexOf("repulse")) &&
          a.fn.modes.repulseParticle(e);
        if (a.particles.line_linked.enable || a.particles.move.attract.enable)
          for (b = a.particles.array.length, c = g + 1; c < b; c++)
            (d = a.particles.array[c]),
              a.particles.line_linked.enable &&
                a.fn.interact.linkParticles(e, d),
              a.particles.move.attract.enable &&
                a.fn.interact.attractParticles(e, d),
              a.particles.move.bounce && a.fn.interact.bounceParticles(e, d);
      }
    };
    a.fn.particlesDraw = function() {
      a.canvas.ctx.clearRect(0, 0, a.canvas.w, a.canvas.h);
      a.fn.particlesUpdate();
      for (var b = a.particles.array.length, c = 0; c < b; c++)
        a.particles.array[c].draw();
    };
    ...
    a.fn.interact.linkParticles = function(b, c) {
      var d = b.x - c.x,
        h = b.y - c.y,
        d = Math.sqrt(d * d + h * h);
      d <= a.particles.line_linked.distance &&
        ((d =
    ...
    a.fn.interact.attractParticles = function(b, c) {
      var d = b.x - c.x,
        h = b.y - c.y;
      Math.sqrt(d * d + h * h) <= a.particles.line_linked.distance &&
        ((d /= 1e3 * a.particles.move.attract.rotateX),
        (h /= 1e3 * a.particles.move.attract.rotateY),
        (b.vx -= d),
        (b.vy -= h),
        (c.vx += d),
        (c.vy += h));
    ...
    a.fn.interact.bounceParticles = function(a, c) {
      var b = a.x - c.x,
        h = a.y - c.y;
      Math.sqrt(b * b + h * h) <= a.radius + c.radius &&
        ((a.vx = -a.vx), (a.vy = -a.vy), (c.vx = -c.vx), (c.vy = -c.vy));
    };
    a.fn.modes.pushParticles = function(b, c) {
      b |= 0;
      a.tmp.pushing = !0;
      for (var d = 0; d < b; d++)
      ...
      if (
        ...
        c <= a.interactivity.modes.bubble.distance
          ? 0 <= d &&
            ...
            (a.interactivity.modes.bubble.size != b.radius &&
              (a.interactivity.modes.bubble.size > b.radius
                ? ((c = b.radius + a.interactivity.modes.bubble.size * d),
                  0 <= c && (b.radius_bubble = c))
                : ((c =
                    b.radius -
                    (b.radius - a.interactivity.modes.bubble.size) * d),
                  (b.radius_bubble = 0 < c ? c : 0))),
            a.interactivity.modes.bubble.opacity != b.opc &&
              (a.interactivity.modes.bubble.opacity > b.opc
                ? ((c = a.interactivity.modes.bubble.opacity * d),
                  c > b.opacity &&
                    c <= a.interactivity.modes.bubble.opacity &&
                    (b.opacity_bubble = c))
                : ((c =
                    b.opacity -
                    (b.opc - a.interactivity.modes.bubble.opacity) * d),
                  c < b.opacity &&
                    c >= a.interactivity.modes.bubble.opacity &&
                    (b.opacity_bubble = c))))
          : ((b.opacity_bubble = b.opacity), (b.radius_bubble = b.radius));
        "mouseleave" == a.interactivity.status &&
          ((b.opacity_bubble = b.opacity), (b.radius_bubble = b.radius));
      } else
        a.interactivity.events.onclick.enable &&
          -1 < a.interactivity.events.onclick.mode.indexOf("bubble") &&
          (a.tmp.bubble_clicking &&
            ((c = b.x - a.interactivity.mouse.click_pos_x),
            (d = b.y - a.interactivity.mouse.click_pos_y),
            (c = Math.sqrt(c * c + d * d)),
            (d =
    ...
    a.fn.modes.repulseParticle = function(b) {
      ...
      if (
        ...
        var g = Math.min(
          Math.max((1 / c) * (-1 * Math.pow(f / c, 2) + 1) * c * 100, 0),
          50
        );
        c = b.x + (h / f) * g;
        d = b.y + (d / f) * g;
        "bounce" == a.particles.move.out_mode
          ? (0 < c - b.radius && c + b.radius < a.canvas.w && (b.x = c),
            0 < d - b.radius && d + b.radius < a.canvas.h && (b.y = d))
          : ((b.x = c), (b.y = d));
      } else
        a.interactivity.events.onclick.enable &&
          -1 < a.interactivity.events.onclick.mode.indexOf("repulse") &&
          ...
          a.tmp.repulse_clicking
            ? ((c = Math.pow(a.interactivity.modes.repulse.distance / 6, 3)),
              (f = a.interactivity.mouse.click_pos_x - b.x),
              (h = a.interactivity.mouse.click_pos_y - b.y),
              (g = f * f + h * h),
              (d = (-c / g) * 1),
              g <= c &&
                ((c = Math.atan2(h, f)),
                ...
                "bounce" == a.particles.move.out_mode &&
                  ((c = b.x + b.vx),
                  (d = b.y + b.vy),
                  c + b.radius > a.canvas.w
                    ? (b.vx = -b.vx)
                    : 0 > c - b.radius && (b.vx = -b.vx),
                  d + b.radius > a.canvas.h
                    ? (b.vy = -b.vy)
                    : 0 > d - b.radius && (b.vy = -b.vy))))
            : 0 == a.tmp.repulse_clicking &&
              ((b.vx = b.vx_i), (b.vy = b.vy_i)));
    };
    a.fn.modes.grabParticle = function(b) {
      if (
        ...
        var c = b.x - a.interactivity.mouse.pos_x,
          d = b.y - a.interactivity.mouse.pos_y,
          c = Math.sqrt(c * c + d * d);
        c <= a.interactivity.modes.grab.distance &&
          ((c =
    ...
    a.fn.vendors.eventsListeners = function() {
      a.interactivity.el =
        "window" == a.interactivity.detect_on ? window : a.canvas.el;
      if (
        a.interactivity.events.onhover.enable ||
        a.interactivity.events.onclick.enable
      )
        l.on("mousemove.rsparticles", function(b) {
      ...
      a.interactivity.events.onclick.enable &&
        a.interactivity.el.addEventListener("click", function() {
          ...
          if (a.interactivity.events.onclick.enable)
    ...
    a.fn.vendors.densityAutoParticles = function() {
      if (a.particles.number.density.enable) {
        var b = (a.canvas.el.width * a.canvas.el.height) / 1e3;
        a.tmp.retina && (b /= 2 * a.canvas.pxratio);
        b =
          a.particles.array.length -
          (b * a.particles.number.value) /
    ...
    a.fn.vendors.checkOverlap = function(b, c) {
      for (var d = a.particles.array.length, f = 0; f < d; f++) {
        var g = a.particles.array[f],
          k = b.x - g.x,
          e = b.y - g.y;
        Math.sqrt(k * k + e * e) <= b.radius + g.radius &&
    ...
    a.fn.vendors.createSvgImg = function(b) {
      var c = a.tmp.source_svg
          .replace(/#([0-9A-F]{3,6})/gi, n.call(b))
          .replace("{{stroke-color}}", b.strokeColor),
        d = new Image(),
      ...
      "image" == a.particles.shape.type
        ? "svg" == a.tmp.img_type
          ? a.tmp.count_svg >= a.particles.number.value
            ? (a.fn.particlesDraw(),
              a.particles.move.enable
                ? (a.fn.drawAnimFrame = rspRequestAnimFrame(a.fn.vendors.draw))
                : rspCancelAnimFrame(a.fn.drawAnimFrame))
            : a.tmp.img_error ||
              (a.fn.drawAnimFrame = rspRequestAnimFrame(a.fn.vendors.draw))
    ...
    a.fn.vendors.checkBeforeDraw = function() {
      "image" == a.particles.shape.type
        ? "svg" == a.tmp.img_type && void 0 == a.tmp.source_svg
          ? (a.tmp.checkAnimFrame = rspRequestAnimFrame(check))
          : (rspCancelAnimFrame(a.tmp.checkAnimFrame),
    ...
    a.fn.vendors.start = function() {
      -1 < a.particles.shape.type.indexOf("image")
        ? ((a.tmp.img_type = "svg"),
          a.fn.vendors.loadImg(a.tmp.img_type, a.particles.shape.image.src))
        : a.fn.vendors.checkBeforeDraw();
    };
  ...
  Object.deepExtend = function(f, k) {
    for (var g in k)
      k[g] && k[g].constructor && k[g].constructor === Object
        ? ((f[g] = f[g] || {}), arguments.callee(f[g], k[g]))
        : (f[g] = k[g]);
    return f;
  };
