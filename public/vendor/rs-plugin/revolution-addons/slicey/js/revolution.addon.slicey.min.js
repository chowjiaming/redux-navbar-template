...
(function($) {
  ...
  var init = function(opt) {
    ...
    opt.c.find(".tp-slicey").each(function() {
      ...
      _.slicey_offset_end =
        _.slicey_offset === undefined
          ? 1
          : 1 + parseInt(_.slicey_offset, 10) * 0.01;

      _.slicey_blurstart =
        _.slicey_blurstart === undefined || _.slicey_blurstart === "inherit"
          ? shd.blurstart
          : _.slicey_blurstart;
      _.slicey_blurend =
        _.slicey_blurend === undefined || _.slicey_blurend === "inherit"
          ? shd.blurend
          : _.slicey_blurend;

      di.removeClass("tp-bgimg")
        .removeClass("defaultimg")
        .addClass("slicedbox_defmig");

      var wp = jQuery(
        '<div class="slicedbox_wrapper" data-slicey_offset_start="' +
          _.slicey_offset_start +
          '" data-slicey_offset_end="' +
          _.slicey_offset_end +
          '" data-global_duration="' +
          shd.duration / 1000 +
          '" data-global_ease="' +
          shd.ease +
          '" data-slicey_blurstart="' +
          _.slicey_blurstart +
          '" data-slicey_blurend="' +
          _.slicey_blurend +
          '" data-global_scalestart="' +
          shd.scalestart / 100 +
          '" data-global_scaleend="' +
          shd.scaleend / 100 +
          '" style="width:100%;height:100%;position:absolute;overflow:hidden;box-shadow:' +
          li.data("slicey_shadow") +
          '"></div>'
      );
    ...
    opt.c.on("revolution.slide.onafterswap", function(event, obj) {
      ...
      for (var i in opt.slidecobjects) {
        var l = opt.slidecobjects[i].caption,
          ls = l.data();
        if (ind === opt.slidecobjects[i].li_index) updateSlicedBox(l, ls, opt);
      }
    });
    ...
    jQuery(window).resize(function() {
      ...
      opt.sliced_resize_timer = setTimeout(function() {
        for (var i in opt.slidecobjects) {
          ...
          if (
            ali.length === 0 ||
            ali.data("index") === opt.slidecobjects[i].li_index
          ) {
  ...
  var updateSlicedBox = function(l, _, opt) {
    _.slicedbox_wrapper =
      _.slicedbox_wrapper == undefined
        ? l.find(".slicedbox_wrapper")
        : _.slicedbox_wrapper;
    if (_.slicedbox_wrapper.length > 0) {
      _.slicedbox_defmig =
        _.slicedbox_defmig == undefined
          ? l.find(".slicedbox_defmig")
          : _.slicedbox_defmig;
      _.origin_offset = {
      ...
      punchgs.TweenLite.set(_.slicedbox_defmig, {
        opacity: 1,
        left: 0 - _.calcx + "px",
        top: 0 - _.calcy + "px",
        width: opt.conw,
  ...
  var animateSlicedBox = function(l, ls, prog) {
    if (ls.slicedbox_wrapper.length > 0) {
      ...
      if (prog === "update" && _.slicedanimation !== undefined)
        prog = _.slicedanimation.progress();
      ...
      /*_.x = {
			...
			*/
      _.slicedanimation.add(
        punchgs.TweenLite.fromTo(
          ls.slicedbox_wrapper,
          _.global_duration,
          {
            transformOrigin:
              ls.origin_offset.sx + "px " + ls.origin_offset.sy + "px",
            scale: _.global_scalestart * _.slicey_offset_start
          },
          {
            force3D: "auto",
            scale: _.global_scaleend * _.slicey_offset_end,
            ease: _.global_ease
          }
        ),
        0
      ...
      if (
        _.slicey_blurstart !== undefined &&
        _.slicey_blurend !== undefined &&
        (_.slicey_blurstart !== 0 || _.slicey_blurend !== 0)
      ) {
        _.blurElement = { a: _.slicey_blurstart };
        _.blurElementEnd = { a: _.slicey_blurend, ease: _.global_ease };
        _.blurAnimation = new punchgs.TweenLite(
          _.blurElement,
          _.global_duration,
          _.blurElementEnd
        );

        _.blurAnimation.eventCallback(
          "onUpdate",
          function(_, ls) {
            punchgs.TweenLite.set(ls.slicedbox_wrapper, {
              position: "absolute",
              msFilter: "blur(" + _.blurElement.a + "px)",
              filter: "blur(" + _.blurElement.a + "px)",
              webkitFilter: "blur(" + _.blurElement.a + "px)"
            });
          },
          [_, ls]
        );
